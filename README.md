...
NOTE: This repo along with our source code itself (_including our NPM packages_) continue to be governed by the open source [MIT license](https://github.com/microsoft/AdaptiveCards/blob/main/LICENSE).
### Community SDKs
