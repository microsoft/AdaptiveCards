...
public class ImageRendererOverride extends BaseCardElementRenderer
{
    private ImageLoadedListener m_imageLoadedListener;

    public ImageRendererOverride(ImageLoadedListener listener)
    {
        m_imageLoadedListener = listener;
    }
    ...
    public class ImageRendererImageLoaderAsync extends InnerImageLoaderAsync
    {
        ...
        protected void renderBitmap(Bitmap bitmap)
        {
            ...
            m_imageLoadedListener.notifyLoaded();
        }
        ...
        RenderArgs renderArgs)
    {
        ...
        ImageRendererOverride.ImageRendererImageLoaderAsync imageLoaderAsync = new ImageRendererOverride.ImageRendererImageLoaderAsync(
            renderedCard,
            imageView,
