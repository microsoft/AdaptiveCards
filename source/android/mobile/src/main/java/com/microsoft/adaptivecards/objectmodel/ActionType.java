...
public final class ActionType {
  public final static ActionType ShowCard = new ActionType("ShowCard", AdaptiveCardObjectModelJNI.ActionType_ShowCard_get());
  ...
  private static ActionType[] swigValues = { ShowCard, Submit, Http, OpenUrl };
