...
public class DateTimePreparsedTokenVector extends java.util.AbstractList<DateTimePreparsedToken> implements java.util.RandomAccess {
  ...
  public DateTimePreparsedTokenVector(int count, DateTimePreparsedToken value) {
    this(AdaptiveCardObjectModelJNI.new_DateTimePreparsedTokenVector__SWIG_2(count, DateTimePreparsedToken.getCPtr(value), value), true);
  }
  ...
  private void doAdd(DateTimePreparsedToken x) {
    AdaptiveCardObjectModelJNI.DateTimePreparsedTokenVector_doAdd__SWIG_0(swigCPtr, this, DateTimePreparsedToken.getCPtr(x), x);
  }

  private void doAdd(int index, DateTimePreparsedToken x) {
    AdaptiveCardObjectModelJNI.DateTimePreparsedTokenVector_doAdd__SWIG_1(swigCPtr, this, index, DateTimePreparsedToken.getCPtr(x), x);
  }
  ...
  private DateTimePreparsedToken doSet(int index, DateTimePreparsedToken val) {
    long cPtr = AdaptiveCardObjectModelJNI.DateTimePreparsedTokenVector_doSet(swigCPtr, this, index, DateTimePreparsedToken.getCPtr(val), val);
    return (cPtr == 0) ? null : new DateTimePreparsedToken(cPtr, true);
  }
