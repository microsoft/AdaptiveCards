...
public class ImageVector extends java.util.AbstractList<Image> implements java.util.RandomAccess {
  ...
  public ImageVector(int count) {
    this(AdaptiveCardObjectModelJNI.new_ImageVector__SWIG_2(count), true);
  }

  public ImageVector(int count, Image value) {
    this(AdaptiveCardObjectModelJNI.new_ImageVector__SWIG_3(count, Image.getCPtr(value), value), true);
  }
  ...
  private void doAdd(Image value) {
    AdaptiveCardObjectModelJNI.ImageVector_doAdd__SWIG_0(swigCPtr, this, Image.getCPtr(value), value);
  }

  private void doAdd(int index, Image value) {
    AdaptiveCardObjectModelJNI.ImageVector_doAdd__SWIG_1(swigCPtr, this, index, Image.getCPtr(value), value);
  }
  ...
  private Image doSet(int index, Image value) {
    long cPtr = AdaptiveCardObjectModelJNI.ImageVector_doSet(swigCPtr, this, index, Image.getCPtr(value), value);
    return (cPtr == 0) ? null : new Image(cPtr, true);
  }
