...
public class DropdownElementRenderer implements IBaseActionElementRenderer {
    ...
    @Override
    public Button render(RenderedAdaptiveCard renderedCard, Context context, FragmentManager fragmentManager, ViewGroup viewGroup, BaseActionElement baseActionElement, ICardActionHandler cardActionHandler, IChoicesResolver choicesResolver, HostConfig hostConfig, RenderArgs renderArgs) throws AdaptiveFallbackException
    {
