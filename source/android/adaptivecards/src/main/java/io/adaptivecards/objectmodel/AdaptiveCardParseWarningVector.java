...
public class AdaptiveCardParseWarningVector extends java.util.AbstractList<AdaptiveCardParseWarning> implements java.util.RandomAccess {
  ...
  public AdaptiveCardParseWarningVector(int count) {
    this(AdaptiveCardObjectModelJNI.new_AdaptiveCardParseWarningVector__SWIG_2(count), true);
  }

  public AdaptiveCardParseWarningVector(int count, AdaptiveCardParseWarning value) {
    this(AdaptiveCardObjectModelJNI.new_AdaptiveCardParseWarningVector__SWIG_3(count, AdaptiveCardParseWarning.getCPtr(value), value), true);
  }
  ...
  private void doAdd(AdaptiveCardParseWarning value) {
    AdaptiveCardObjectModelJNI.AdaptiveCardParseWarningVector_doAdd__SWIG_0(swigCPtr, this, AdaptiveCardParseWarning.getCPtr(value), value);
  }

  private void doAdd(int index, AdaptiveCardParseWarning value) {
    AdaptiveCardObjectModelJNI.AdaptiveCardParseWarningVector_doAdd__SWIG_1(swigCPtr, this, index, AdaptiveCardParseWarning.getCPtr(value), value);
  }
  ...
  private AdaptiveCardParseWarning doSet(int index, AdaptiveCardParseWarning value) {
    long cPtr = AdaptiveCardObjectModelJNI.AdaptiveCardParseWarningVector_doSet(swigCPtr, this, index, AdaptiveCardParseWarning.getCPtr(value), value);
    return (cPtr == 0) ? null : new AdaptiveCardParseWarning(cPtr, true);
  }
