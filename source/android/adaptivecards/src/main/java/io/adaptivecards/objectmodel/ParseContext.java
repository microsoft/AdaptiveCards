...
public class ParseContext {
  ...
  public ParseContext(ElementParserRegistration elementRegistration, ActionParserRegistration actionRegistration, FeatureRegistration featureRegistration) {
    this(AdaptiveCardObjectModelJNI.new_ParseContext__SWIG_1(ElementParserRegistration.getCPtr(elementRegistration), elementRegistration, ActionParserRegistration.getCPtr(actionRegistration), actionRegistration, FeatureRegistration.getCPtr(featureRegistration), featureRegistration), true);
  }
