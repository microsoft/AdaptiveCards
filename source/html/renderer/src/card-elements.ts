...
function getEffectiveSpacing(hostConfig: HostConfig.HostConfig, spacing: Enums.Spacing): number {
    switch (spacing) {
...
function getEffectivePadding(hostConfig: HostConfig.HostConfig, padding: Enums.Padding): number {
    switch (padding) {
