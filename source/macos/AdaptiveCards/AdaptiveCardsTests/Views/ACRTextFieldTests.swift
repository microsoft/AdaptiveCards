...
class ACRTextFieldTests: XCTestCase {
    ...
    override func setUp() {
        ...
        config = RenderConfig(isDarkMode: false, buttonConfig: .default, supportsSchemeV1_3: false, hyperlinkColorConfig: .default, inputFieldConfig: inputFieldConfig)
    ...
    func testChangingRenderConfigChangesProperties() {
        ...
        let config = RenderConfig(isDarkMode: false, buttonConfig: .default, supportsSchemeV1_3: false, hyperlinkColorConfig: .default, inputFieldConfig: inputFieldConfig)
        textField = ACRTextField(frame: .zero, config: config)
