...
class RootViewController: NSViewController, NSTableViewDelegate, NSTableViewDataSource, NSComboBoxDelegate, NSComboBoxDataSource {
    ...
    private func setupInputFieldConfig() {
        if darkTheme {
            ...
            inputFieldConfig = InputFieldConfig(height: 32, leftPadding: 8, rightPadding: 8, yPadding: 1, focusRingCornerRadius: 8, borderWidth: 1, wantsClearButton: true, clearButtonImage: clearButtonimage, calendarImage: calendarImage, clockImage: clockImage, font: .systemFont(ofSize: 14), highlightedColor: NSColor(red: 0, green: 0, blue: 0, alpha: 0.07), backgroundColor: NSColor(red: 1, green: 1, blue: 1, alpha: 1), borderColor: NSColor(red: 0, green: 0, blue: 0, alpha: 0.3), activeBorderColor: NSColor(red: 0.38, green: 0.61, blue: 0.97, alpha: 1), placeholderTextColor: NSColor(red: 0, green: 0, blue: 0, alpha: 0.6))
        }
    }
