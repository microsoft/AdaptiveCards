...
AdaptiveElementParserRegistration::AdaptiveElementParserRegistration()
{
    ...
    m_sharedParserRegistration->AddParser(
        ::AdaptiveCards::ObjectModel::Uwp::c_uwpElementParserRegistration,
        std::make_shared<::AdaptiveCards::ObjectModel::Uwp::SharedModelElementParser>(*this));

    m_isInitializing = false;
}

void AdaptiveElementParserRegistration::Set(hstring const& type, winrt::AdaptiveCards::ObjectModel::Uwp::IAdaptiveElementParser const& Parser)
{
    ...
    if (!m_isInitializing)
    {
        m_sharedParserRegistration->AddParser(typeString, std::make_shared<::AdaptiveCards::ObjectModel::Uwp::SharedModelElementParser>(*this));
    }
...
std::shared_ptr<::AdaptiveCards::BaseCardElement> SharedModelElementParser::DeserializeFromString(
    ::AdaptiveCards::ParseContext& context, const std::string& jsonString)
{
...
std::shared_ptr<::AdaptiveCards::BaseCardElement> SharedModelElementParser::Deserialize(::AdaptiveCards::ParseContext& context, const Json::Value& value)
{
    ...
    auto cardElement = parser.FromJson(jsonObject, adaptiveElementParserRegistration, adaptiveActionParserRegistration, adaptiveWarnings);
