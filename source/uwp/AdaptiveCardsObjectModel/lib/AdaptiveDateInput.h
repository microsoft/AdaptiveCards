...
{
struct DECLSPEC_UUID("9aa05662-098b-4588-addb-af62378a8706") AdaptiveDateInput : AdaptiveDateInputT<AdaptiveDateInput, ITypePeek>, AdaptiveInputElementBase
{
    AdaptiveDateInput(const std::shared_ptr<::AdaptiveCards::DateInput>& sharedDateInput = std::make_shared<::AdaptiveCards::DateInput>());

    auto ElementType()
    {
        return ElementType::DateInput;
    }
