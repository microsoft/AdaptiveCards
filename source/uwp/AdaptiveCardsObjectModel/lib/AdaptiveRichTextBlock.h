...
struct DECLSPEC_UUID("0c87566c-a58c-4332-8b3b-79c9714074f6") AdaptiveRichTextBlock : AdaptiveRichTextBlockT<AdaptiveRichTextBlock, ITypePeek>, AdaptiveCardElementBase
{
    AdaptiveRichTextBlock(
        const std::shared_ptr<::AdaptiveCards::RichTextBlock>& sharedRichTextBlock = std::make_shared<::AdaptiveCards::RichTextBlock>()) noexcept;
    ...
    auto ElementType()
    {
        return ElementType::RichTextBlock;
    }
