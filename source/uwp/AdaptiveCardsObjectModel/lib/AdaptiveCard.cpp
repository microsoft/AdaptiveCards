    ...
    winrt::AdaptiveCards::ObjectModel::Uwp::AdaptiveActionParserRegistration const& actionParserRegistration)
{
    ...
    try
    {
        ...
        adaptiveParseResult->AdaptiveCard = *winrt::make_self<implementation::AdaptiveCard>(sharedParseResult->GetAdaptiveCard());
    ...
    catch (::AdaptiveCards::AdaptiveCardParseException const& e)
    {
        auto error = winrt::make_self<implementation::AdaptiveError>(
            static_cast<winrt::AdaptiveCards::ObjectModel::Uwp::ErrorStatusCode>(e.GetStatusCode()), UTF8ToHString(e.GetReason()));
...
AdaptiveCard::AdaptiveCard(std::shared_ptr<::AdaptiveCards::AdaptiveCard> const& sharedAdaptiveCard)
{
    ...
    VerticalContentAlignment =
        static_cast<winrt::AdaptiveCards::ObjectModel::Uwp::VerticalContentAlignment>(sharedAdaptiveCard->GetVerticalContentAlignment());
    ...
    {
        Authentication = *winrt::make_self<winrt::AdaptiveCards::ObjectModel::Uwp::implementation::AdaptiveAuthentication>(authentication);
    }
...
winrt::Windows::Foundation::Collections::IVectorView<winrt::AdaptiveCards::ObjectModel::Uwp::AdaptiveRemoteResourceInformation> AdaptiveCard::GetResourceInformation()
{
    ...
    return winrt::single_threaded_vector<winrt::AdaptiveCards::ObjectModel::Uwp::AdaptiveRemoteResourceInformation>(std::move(resourceInformation))
        .GetView();
}
} // namespace winrt::AdaptiveCards::ObjectModel::Uwp::implementation
