...
{
    AdaptiveToggleVisibilityAction() : AdaptiveToggleVisibilityAction(std::make_shared<::AdaptiveCards::ToggleVisibilityAction>())
    {
    }
...
struct AdaptiveToggleVisibilityAction
    : AdaptiveToggleVisibilityActionT<AdaptiveToggleVisibilityAction, implementation::AdaptiveToggleVisibilityAction>
{
};
} // namespace winrt::AdaptiveCards::ObjectModel::Uwp::factory_implementation
