...
{
    VerticalCellContentAlignment = opt_cast<Uwp::VerticalContentAlignment>(sharedTableColumnDefinition->GetVerticalCellContentAlignment());
...
std::shared_ptr<::AdaptiveCards::TableColumnDefinition> AdaptiveTableColumnDefinition::GetSharedModel()
{
    ...
    {
        tableColumnDefinition->SetHorizontalCellContentAlignment(HorizontalCellContentAlignment.get<::AdaptiveCards::HorizontalAlignment>());
    }
