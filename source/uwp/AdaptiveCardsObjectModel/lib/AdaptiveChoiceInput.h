...
{
struct DECLSPEC_UUID("7263dbfb-cb43-47f9-9022-b43372f529f9") AdaptiveChoiceInput : AdaptiveChoiceInputT<AdaptiveChoiceInput, ITypePeek>
{
    ...
    auto ElementType()
    {
        return Uwp::ElementType::ChoiceInput;
    }
