...
{
    winrt::AdaptiveCards::ObjectModel::Uwp::IAdaptiveCardElement AdaptiveFactSetParser::FromJson(
    ...
    {
        return ::AdaptiveCards::ObjectModel::Uwp::FromJson<implementation::AdaptiveFactSet, ::AdaptiveCards::FactSet, ::AdaptiveCards::FactSetParser>(
