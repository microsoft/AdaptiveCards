...
AdaptiveMedia::AdaptiveMedia(const std::shared_ptr<::AdaptiveCards::Media>& sharedMedia)
{
    ...
    Sources = GenerateVectorProjection<winrt::AdaptiveCards::ObjectModel::Uwp::implementation::AdaptiveMediaSource>(
        sharedMedia->GetSources());
...
std::shared_ptr<::AdaptiveCards::BaseCardElement> AdaptiveMedia::GetSharedModel()
{
    ...
    media->GetSources() =
        GenerateSharedVector<winrt::AdaptiveCards::ObjectModel::Uwp::implementation::AdaptiveMediaSource, ::AdaptiveCards::MediaSource>(
            Sources.get());
