...
AdaptiveActionParserRegistration::AdaptiveActionParserRegistration()
{
    ...
    m_sharedParserRegistration->AddParser(
        ::AdaptiveCards::ObjectModel::Uwp::c_upwActionParserRegistration,
...
void AdaptiveActionParserRegistration::Set(hstring const& type, _In_ Uwp::IAdaptiveActionParser const& Parser)
{
    ...
    if (!m_isInitializing)
    {
        m_sharedParserRegistration->AddParser(typeString, std::make_shared<::AdaptiveCards::ObjectModel::Uwp::SharedModelActionParser>(*this));
    }
}
...
std::shared_ptr<BaseActionElement> SharedModelActionParser::Deserialize(ParseContext& context, const Json::Value& value)
{
    ...
    auto adaptiveElementParserRegistration = GetAdaptiveElementParserRegistrationFromSharedModel(context.elementParserRegistration);
