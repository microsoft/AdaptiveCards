...
#pragma once
#include "AdaptiveFactParser.g.h"

namespace winrt::AdaptiveCards::ObjectModel::Uwp::implementation
{
    struct AdaptiveFactParser : AdaptiveFactParserT<AdaptiveFactParser>
    {
        AdaptiveFactParser() = default;
...
{
    struct AdaptiveFactParser : AdaptiveFactParserT<AdaptiveFactParser, implementation::AdaptiveFactParser>
    {
    };
}
