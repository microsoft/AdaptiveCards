...
{
    AdaptiveTableColumnDefinition() : AdaptiveTableColumnDefinition(std::make_shared<::AdaptiveCards::TableColumnDefinition>())
    {
    }
...
struct AdaptiveTableColumnDefinition : AdaptiveTableColumnDefinitionT<AdaptiveTableColumnDefinition, implementation::AdaptiveTableColumnDefinition>
{
};
} // namespace winrt::AdaptiveCards::ObjectModel::Uwp::factory_implementation
