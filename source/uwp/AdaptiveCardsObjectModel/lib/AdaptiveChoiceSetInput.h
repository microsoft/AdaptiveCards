...
struct DECLSPEC_UUID("fa103f57-5d54-48ba-80a5-d8939b85e82d") AdaptiveChoiceSetInput : AdaptiveChoiceSetInputT<AdaptiveChoiceSetInput, ITypePeek>, implementation::AdaptiveInputElementBase
{
    ...
    auto ElementType()
    {
        return Uwp::ElementType::ChoiceSetInput;
    }
