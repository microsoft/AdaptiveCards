...
{
    TargetElements = project_vector<Uwp::AdaptiveToggleVisibilityTarget, implementation::AdaptiveToggleVisibilityTarget>(
        sharedToggleVisibilityAction->GetTargetElements());
...
std::shared_ptr<::AdaptiveCards::BaseActionElement> AdaptiveToggleVisibilityAction::GetSharedModel()
{
    ...
    toggleVisibilityAction->GetTargetElements() =
        project_vector<::AdaptiveCards::ToggleVisibilityTarget, implementation::AdaptiveToggleVisibilityTarget>(TargetElements.get());
