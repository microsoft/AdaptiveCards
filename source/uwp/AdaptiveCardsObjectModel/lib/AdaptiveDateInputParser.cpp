...
{
    winrt::AdaptiveCards::ObjectModel::Uwp::IAdaptiveCardElement AdaptiveDateInputParser::FromJson(
    ...
    {
        return ::AdaptiveCards::ObjectModel::Uwp::FromJson<implementation::AdaptiveDateInput, ::AdaptiveCards::DateInput, ::AdaptiveCards::DateInputParser>(
