...
public:
    ...
    std::shared_ptr<::AdaptiveCards::BaseCardElement> Deserialize(::AdaptiveCards::ParseContext& context, const Json::Value& value) override;

    std::shared_ptr<::AdaptiveCards::BaseCardElement> DeserializeFromString(::AdaptiveCards::ParseContext& context, const std::string& jsonString) override;
...
auto FromJson(
    _In_ winrt::Windows::Data::Json::JsonObject const& jsonObject,
    ...
    _In_ winrt::Windows::Foundation::Collections::IVector<winrt::AdaptiveCards::ObjectModel::Uwp::AdaptiveWarning> const& adaptiveWarnings)
{
    auto elementParserRegistrationImpl =
        peek_innards<winrt::AdaptiveCards::ObjectModel::Uwp::implementation::AdaptiveElementParserRegistration>(elementParserRegistration);
    ...
    ParseContext context(
        elementParserRegistrationImpl->GetSharedParserRegistration(), actionParserRegistrationImpl->GetSharedParserRegistration());
