...
namespace AdaptiveCardTestApp.ViewModels
{
    public class RunningTestsViewModel : BindableBase
    {
        ...
        private async Task<Tuple<string, StorageFile, StorageFile, UIElement>> RenderCard(FileViewModel cardFile, FileViewModel hostConfigFile, Dictionary<string, IAdaptiveCardResourceResolver> resourceResolvers)
        {
