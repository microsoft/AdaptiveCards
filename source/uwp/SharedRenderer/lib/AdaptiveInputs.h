...
namespace winrt::AdaptiveCards::Rendering::Xaml_Rendering::implementation
{
    struct AdaptiveInputs : AdaptiveInputsT<AdaptiveInputs>
    {
        ...
        void LinkSubmitActionToCard(winrt::IAdaptiveActionElement const& action, winrt::render_xaml::AdaptiveRenderArgs const& renderArgs);
    ...
    private:
        ...
        std::vector<winrt::render_xaml::IAdaptiveInputValue> GetInputsToValidate(winrt::IAdaptiveActionElement const& submitAction);
        ...
        std::unordered_map<std::string, winrt::render_xaml::IAdaptiveInputValue> m_inputValues;
        ...
        std::vector<winrt::render_xaml::IAdaptiveInputValue> m_lastRetrievedValues;
