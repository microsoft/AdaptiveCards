...
namespace UWPUnitTests
{
    ...
    public class ObjectModelTest
    {
        ...
        public void TextBlock()
        {
            ...
            ValidateBaseElementProperties(textBlock, "TextBlockId", true, Spacing.Large, HeightType.Stretch);
            ...
            Assert.AreEqual("{\"color\":\"Accent\",\"height\":\"Stretch\",\"horizontalAlignment\":\"Center\",\"id\":\"TextBlockId\",\"isSubtle\":true,\"maxLines\":3,\"separator\":true,\"size\":\"Large\",\"spacing\":\"large\",\"text\":\"This is a text block\",\"type\":\"TextBlock\",\"weight\":\"Bolder\",\"wrap\":true}", jsonString);
        }
        ...
        public void Image()
        {
            ...
            ValidateBaseElementProperties(image, "ImageId", true, Spacing.Large, HeightType.Stretch);
            ...
            Assert.AreEqual("{\"altText\":\"This is a picture\",\"backgroundColor\":\"0xffffffff\",\"height\":\"50px\",\"horizontalAlignment\":\"Center\",\"id\":\"ImageId\",\"separator\":true,\"spacing\":\"large\",\"style\":\"person\",\"type\":\"Image\",\"url\":\"https://www.stuff.com/picture.jpg\",\"width\":\"40px\"}", jsonString);
        }
        ...
        public void Media()
        {
            ...
            ValidateBaseElementProperties(media, "MediaId", true, Spacing.Large, HeightType.Stretch);
            ...
            Assert.AreEqual("{\"altText\":\"This is some audio\",\"height\":\"Stretch\",\"id\":\"MediaId\",\"poster\":\"https://www.stuff.com/poster.jpg\",\"separator\":true,\"sources\":[{\"mimeType\":\"audio/mp4\",\"url\":\"https://www.stuff.com/media.mp4\"},{\"mimeType\":\"audio/mpeg\",\"url\":\"https://www.stuff.com/media.mp3\"}],\"spacing\":\"large\",\"type\":\"Media\"}", jsonString);
        }
        ...
        public void Container()
        {
            ...
            ValidateBaseElementProperties(container, "ContainerId", true, Spacing.ExtraLarge, HeightType.Stretch);
        ...
        public void ColumnSet()
        {
            ...
            ValidateBaseElementProperties(column1, "ColumnId", true, Spacing.Small, HeightType.Stretch);
            ...
            ValidateBaseElementProperties(columnSet, "ColumnSetId", true, Spacing.Small, HeightType.Stretch);
        ...
        public void FactSet()
        {
            ...
            ValidateBaseElementProperties(factSet, "FactSetId", true, Spacing.Medium, HeightType.Stretch);
            ...
            Assert.AreEqual("{\"facts\":[{\"title\":\"Title1\",\"value\":\"Value1\"},{\"title\":\"Title2\",\"value\":\"Value2\"}],\"height\":\"Stretch\",\"id\":\"FactSetId\",\"separator\":true,\"spacing\":\"medium\",\"type\":\"FactSet\"}", jsonString);
        }
        ...
        public void ImageSet()
        {
            ...
            ValidateBaseElementProperties(imageSet, "ImageSetId", true, Spacing.Medium, HeightType.Stretch);
            ...
            Assert.AreEqual("{\"height\":\"Stretch\",\"id\":\"ImageSetId\",\"imageSize\":\"Small\",\"images\":[{\"id\":\"Image1Id\",\"type\":\"Image\",\"url\":\"https://www.stuff.com/picture.jpg\"},{\"id\":\"Image2Id\",\"type\":\"Image\",\"url\":\"https://www.stuff.com/picture2.jpg\"}],\"separator\":true,\"spacing\":\"medium\",\"type\":\"ImageSet\"}", jsonString);
        }
        ...
        public void TextInput()
        {
            ...
            ValidateBaseElementProperties(textInput, "TextInputId", true, Spacing.Medium, HeightType.Stretch);
            ...
            Assert.AreEqual("{\"height\":\"Stretch\",\"id\":\"TextInputId\",\"isMultiline\":true,\"isRequired\":false,\"maxLength\":5,\"placeholder\":\"Placeholder\",\"separator\":true,\"spacing\":\"medium\",\"style\":\"Email\",\"type\":\"Input.Text\",\"value\":\"Value\"}", jsonString);
        }
        ...
        public void NumberInput()
        {
            ...
            ValidateBaseElementProperties(numberInput, "NumberInputId", true, Spacing.Medium, HeightType.Stretch);
            ...
            Assert.AreEqual("{\"height\":\"Stretch\",\"id\":\"NumberInputId\",\"isRequired\":false,\"max\":50,\"min\":40,\"placeholder\":\"Placeholder\",\"separator\":true,\"spacing\":\"medium\",\"type\":\"Input.Number\",\"value\":42}", jsonString);
        }
        ...
        public void DateInput()
        {
            ...
            ValidateBaseElementProperties(dateInput, "DateInputId", true, Spacing.Medium, HeightType.Stretch);
            ...
            Assert.AreEqual("{\"height\":\"Stretch\",\"id\":\"DateInputId\",\"isRequired\":false,\"max\":\"2019-01-14\",\"min\":\"2017-01-14\",\"placeholder\":\"Placeholder\",\"separator\":true,\"spacing\":\"medium\",\"type\":\"Input.Date\",\"value\":\"2018-01-14\"}", jsonString);
        }
        ...
        public void TimeInput()
        {
            ...
            ValidateBaseElementProperties(timeInput, "TimeInputId", true, Spacing.Medium, HeightType.Stretch);
        ...
        public void ToggleInput()
        {
            ...
            ValidateBaseElementProperties(toggleInput, "ToggleInputId", true, Spacing.Medium, HeightType.Stretch);
            ...
            Assert.AreEqual("{\"height\":\"Stretch\",\"id\":\"ToggleInputId\",\"isRequired\":false,\"separator\":true,\"spacing\":\"medium\",\"title\":\"Title\",\"type\":\"Input.Toggle\",\"value\":\"Value\",\"valueOff\":\"ValueOff\",\"valueOn\":\"ValueOn\"}", jsonString);
        }
        ...
        public void ChoiceSetInput()
        {
            ...
            ValidateBaseElementProperties(choiceSet, "ChoiceSetInputId", true, Spacing.Medium, HeightType.Stretch);
            ...
            Assert.AreEqual("{\"choices\":[{\"title\":\"Title1\",\"value\":\"Value1\"},{\"title\":\"Title2\",\"value\":\"Value2\"}],\"height\":\"Stretch\",\"id\":\"ChoiceSetInputId\",\"isMultiSelect\":true,\"isRequired\":false,\"separator\":true,\"spacing\":\"medium\",\"style\":\"Expanded\",\"type\":\"Input.ChoiceSet\",\"value\":\"Value2\"}", jsonString);
        }
        ...
        public void OpenUrlAction()
        {
            ...
            ValidateBaseActionProperties(openUrlAction, "http://www.stuff.com/icon.jpg", "OpenUrlId", "Title");
            Assert.AreEqual(url, openUrlAction.Url);

            var jsonString = openUrlAction.ToJson().ToString();
            Assert.AreEqual("{\"iconUrl\":\"http://www.stuff.com/icon.jpg\",\"id\":\"OpenUrlId\",\"title\":\"Title\",\"type\":\"Action.OpenUrl\",\"url\":\"http://www.stuff.com/\"}", jsonString);
        }
        ...
        public void SubmitAction()
        {
            ...
            ValidateBaseActionProperties(submitAction, "http://www.stuff.com/icon.jpg", "OpenUrlId", "Title");
            Assert.AreEqual(dataJson, submitAction.DataJson);

            var jsonString = submitAction.ToJson().ToString();
            Assert.AreEqual("{\"data\":\"\\\"foo\\\"\",\"iconUrl\":\"http://www.stuff.com/icon.jpg\",\"id\":\"OpenUrlId\",\"title\":\"Title\",\"type\":\"Action.Submit\"}", jsonString);
        }
        ...
        public void ShowCardAction()
        {
            ...
            ValidateBaseActionProperties(showCardAction, "http://www.stuff.com/icon.jpg", "OpenUrlId", "Title");
            ...
            Assert.AreEqual("{\"card\":{\"actions\":[],\"body\":[],\"type\":\"AdaptiveCard\",\"version\":\"1.0\"},\"iconUrl\":\"http://www.stuff.com/icon.jpg\",\"id\":\"OpenUrlId\",\"title\":\"Title\",\"type\":\"Action.ShowCard\"}", jsonString);
        }
    }
}
