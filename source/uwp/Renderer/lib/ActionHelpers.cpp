    ...
    if (action != nullptr)
    {
        ...
        if (actionType == ABI::AdaptiveCards::ObjectModel::Uwp::ActionType::ShowCard)
        {
            THROW_IF_FAILED(renderContext->AddWarning(
                ABI::AdaptiveCards::ObjectModel::Uwp::WarningStatusCode::UnsupportedValue,
    ...
    while (!renderer)
    {
        ...
        if (!renderer)
        {
            ...
            case ABI::AdaptiveCards::ObjectModel::Uwp::FallbackType::Content:
            {
                ...
                RETURN_IF_FAILED(XamlHelpers::WarnForFallbackContentElement(
                    renderContext, actionTypeString.Get(), fallbackTypeString.Get()));
    ...
    _Outptr_ IUIElement** actionSetControl)
{
    ...
    IterateOverVector<IAdaptiveActionElement>(children, [&](IAdaptiveActionElement* child) {
        ...
        else
        {
            ...
            if (mode == ABI::AdaptiveCards::ObjectModel::Uwp::ActionMode::Primary)
            {
                renderContext->AddWarning(
                    ABI::AdaptiveCards::ObjectModel::Uwp::WarningStatusCode::MaxActionsExceeded,
                    HStringReference(L"Some actions were moved to an overflow menu due to exceeding the maximum number "
                                     L"of actions allowed")
                        .Get());
            }
        }
    ...
    RETURN_IF_FAILED(XamlHelpers::SetStyleFromResourceDictionary(
        renderContext, L"Adaptive.Actions", actionsPanelAsFrameworkElement.Get()));
