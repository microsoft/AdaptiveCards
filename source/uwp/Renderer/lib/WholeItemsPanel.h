...
class DECLSPEC_UUID("32934D77-6248-4915-BD2A-8F52EF6C8322") WholeItemsPanel
    : public Microsoft::WRL::RuntimeClass<
          ABI::AdaptiveCards::Rendering::Uwp::IWholeItemsPanel,
...
private:
    ...
    static _Check_return_ HRESULT LayoutCroppedImage(
        _In_ ABI::Windows::UI::Xaml::Shapes::IShape* pShape, _In_ double availableWidth, _In_ double availableHeight);
