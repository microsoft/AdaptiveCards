...
class AdaptiveInputs
    : public Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<Microsoft::WRL::RuntimeClassType::WinRtClassicComMix>, ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveInputs>
{
...
public:
    ...
    IFACEMETHODIMP ValidateInputs(_In_ ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveActionElement* submitAction, boolean* inputsAreValid);

    HRESULT AddInputValue(
        _In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveInputValue* inputValue,
        _In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveRenderArgs* renderArgs);
    HRESULT LinkSubmitActionToCard(
...
private:
    ...
    HRESULT AdaptiveInputs::GetInternalIdFromAction(_In_ ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveActionElement* action, _Out_ UINT32* actionInternalId);
