...
ComPtr<IUIElement> CreateSeparator(
    _In_ IAdaptiveRenderContext* renderContext, UINT spacing, UINT separatorThickness, ABI::Windows::UI::Color separatorColor, bool isHorizontal)
{
    ComPtr<IGrid> separator = XamlHelpers::CreateABIClass<IGrid>(HStringReference(RuntimeClass_Windows_UI_Xaml_Controls_Grid));
    ...
    THROW_IF_FAILED(XamlHelpers::SetStyleFromResourceDictionary(renderContext, L"Adaptive.Separator", separatorAsFrameworkElement.Get()));
...
HRESULT SetStyleFromResourceDictionary(_In_ IAdaptiveRenderContext* renderContext, HSTRING resourceName, _In_ IFrameworkElement* frameworkElement) noexcept
{
...
HRESULT SetStyleFromResourceDictionary(_In_ IAdaptiveRenderContext* renderContext, const wchar_t* resourceName, _In_ IFrameworkElement* frameworkElement) noexcept
{
    return SetStyleFromResourceDictionary(renderContext, HStringReference(resourceName).Get(), frameworkElement);
}

void SetStyleFromResourceDictionary(
...
HRESULT HandleStylingAndPadding(
    _In_ IAdaptiveContainerBase* adaptiveContainer,
...
HRESULT HandleColumnWidth(_In_ IAdaptiveColumn* column, boolean isVisible, _In_ IColumnDefinition* columnDefinition)
{
    ...
    GridLength columnWidth = CalculateColumnWidth(isVisible, isAuto, isStretch, !adaptiveColumnWidth.IsValid(), pixelWidth, widthAsDouble);
...
void ApplyBackgroundToRoot(_In_ IPanel* rootPanel, _In_ IAdaptiveBackgroundImage* backgroundImage, _In_ IAdaptiveRenderContext* renderContext, _In_ IAdaptiveRenderArgs* renderArgs)
{
    ...
    if (SUCCEEDED(XamlHelpers::TryGetResourceFromResourceDictionaries<IBrush>(
            resourceDictionary.Get(), c_BackgroundImageOverlayBrushKey, &backgroundOverlayBrush)))
    {
...
HRESULT RenderFallback(
    _In_ IAdaptiveCardElement* currentElement,
    _In_ IAdaptiveRenderContext* renderContext,
    _In_ IAdaptiveRenderArgs* renderArgs,
    ...
    else
    {
        ...
        if (!ancestorHasFallback)
        {
            ...
            RETURN_IF_FAILED(renderContext->AddWarning(
                ABI::AdaptiveCards::ObjectModel::Uwp::WarningStatusCode::NoRendererForType, HStringReference(errorString.c_str()).Get()));
            return S_OK;
        }
        else
        {
...
void GetSeparationConfigForElement(
    _In_ IAdaptiveCardElement* cardElement,
...
HRESULT AddRenderedControl(
    _In_ IUIElement* newControl,
...
HRESULT AddHandledTappedEvent(_In_ IUIElement* uiElement)
{
    ...
    return uiElement->add_Tapped(
        Callback<ITappedEventHandler>([](IInspectable* /*sender*/, ITappedRoutedEventArgs* args) -> HRESULT {
...
HRESULT FormatLabelRunWithHostConfig(
...
HRESULT RenderInputLabel(
    _In_ ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveInputElement* adaptiveInputElement,
    ...
    _COM_Outptr_ ABI::Windows::UI::Xaml::IUIElement** labelControl)
{
    ...
    if (inputLabel != nullptr)
    {
        ...
        ComPtr<IRun> labelRun = XamlHelpers::CreateABIClass<IRun>(HStringReference(RuntimeClass_Windows_UI_Xaml_Documents_Run));
        ...
        RETURN_IF_FAILED(FormatLabelRunWithHostConfig(hostConfig.Get(), inputLabelConfig.Get(), false /*isHint*/, labelRun.Get()));
...
HRESULT FormatErrorMessageWithHostConfig(_In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveRenderContext* renderContext, ITextBlock* errorMessage)
{
    ...
    UINT32 resultSize{};
    RETURN_IF_FAILED(GetFontSizeFromFontType(hostConfig.Get(), ABI::AdaptiveCards::ObjectModel::Uwp::FontType_Default, textSize, &resultSize));
    ...
    RETURN_IF_FAILED(GetFontWeightFromStyle(hostConfig.Get(), ABI::AdaptiveCards::ObjectModel::Uwp::FontType_Default, textWeight, &resultWeight));
...
HRESULT RenderInputErrorMessage(
    _In_ ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveInputElement* adaptiveInputElement,
    _In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveRenderContext* renderContext,
    _COM_Outptr_ ABI::Windows::UI::Xaml::IUIElement** errorMessageControl)
{
    ...
    if (errorMessage.IsValid())
    {
        ...
        RETURN_IF_FAILED(GetColorFromAdaptiveColor(hostConfig.Get(), ForegroundColor_Attention, ContainerStyle_Default, false, false, &attentionColor));
...
HRESULT CreateValidationBorder(
    _In_ ABI::Windows::UI::Xaml::IUIElement* childElement,
    _In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveRenderContext* renderContext,
...
HRESULT HandleLabelAndErrorMessage(
    _In_ IAdaptiveInputElement* adaptiveInput, _In_ IAdaptiveRenderContext* renderContext, _In_ IAdaptiveRenderArgs* renderArgs, _Out_ IUIElement** inputLayout)
{
...
HRESULT HandleInputLayoutAndValidation(
    IAdaptiveInputElement* adaptiveInput,
    ...
    IBorder** validationBorderOut)
{
    ...
    if (hasValidation)
    {
        ...
        {
            RETURN_IF_FAILED(renderContext->AddWarning(
                ABI::AdaptiveCards::ObjectModel::Uwp::WarningStatusCode::MissingValidationErrorMessage,
    ...
    if (SUCCEEDED(localAdaptiveInput.As(&adaptiveToggleInput)))
    {
        ...
        RETURN_IF_FAILED(
            automationPropertiesStatics5->GetDescribedBy(inputUIElementAsDependencyObject.Get(), uiElementDescribers.GetAddressOf()));
...
winrt::Windows::UI::Xaml::UIElement HandleInputLayoutAndValidation(
    winrt::AdaptiveCards::ObjectModel::Uwp::IAdaptiveInputElement adaptiveInput,
