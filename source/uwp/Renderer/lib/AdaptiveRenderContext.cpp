...
HRESULT AdaptiveRenderContext::AddError(ABI::AdaptiveCards::ObjectModel::Uwp::ErrorStatusCode statusCode, _In_ HSTRING message)
{
    ...
    RETURN_IF_FAILED(GetActivationFactory(HStringReference(RuntimeClass_AdaptiveCards_ObjectModel_Uwp_AdaptiveError).Get(), &errorActivationFactory));
...
HRESULT AdaptiveRenderContext::AddWarning(ABI::AdaptiveCards::ObjectModel::Uwp::WarningStatusCode statusCode, _In_ HSTRING message)
{
    ...
    RETURN_IF_FAILED(GetActivationFactory(HStringReference(RuntimeClass_AdaptiveCards_ObjectModel_Uwp_AdaptiveWarning).Get(), &warningActivationFactory));
...
HRESULT AdaptiveRenderContext::AddInlineShowCard(
    ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveCard* adaptiveCard,
    ...
    ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveRenderArgs* renderArgs)
{
    ComPtr<RenderedAdaptiveCard> renderResult;
    RETURN_IF_FAILED(GetRenderResult(renderResult.GetAddressOf()));
    return renderResult->AddInlineShowCard(adaptiveCard, showCardAction, showCardUIElement, renderArgs);
}

HRESULT AdaptiveRenderContext::AddInlineShowCard(
    _In_opt_ IAdaptiveActionSet* actionSet,
    ...
    _In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveRenderArgs* renderArgs)
{
    ComPtr<RenderedAdaptiveCard> renderResult;
    RETURN_IF_FAILED(GetRenderResult(renderResult.GetAddressOf()));
    return renderResult->AddInlineShowCard(actionSet, showCardAction, showCardUIElement, renderArgs);
}

HRESULT AdaptiveRenderContext::AddOverflowButton(
    _In_ ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveActionSet* actionSet, _In_ ABI::Windows::UI::Xaml::IUIElement* actionUIElement)
{
    ComPtr<RenderedAdaptiveCard> renderResult;
    RETURN_IF_FAILED(GetRenderResult(renderResult.GetAddressOf()));
...
HRESULT AdaptiveRenderContext::AddOverflowButton(
    _In_ ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveCard* actionCard, _In_ ABI::Windows::UI::Xaml::IUIElement* actionUIElement)
{
    ComPtr<RenderedAdaptiveCard> renderResult;
    RETURN_IF_FAILED(GetRenderResult(renderResult.GetAddressOf()));
...
HRESULT AdaptiveRenderContext::LinkSubmitActionToCard(
...
HRESULT AdaptiveRenderContext::LinkCardToParent(
    _In_ ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveCard* card, _In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveRenderArgs* renderArgs)
{
    ComPtr<RenderedAdaptiveCard> renderResult;
    RETURN_IF_FAILED(GetRenderResult(renderResult.GetAddressOf()));
    RETURN_IF_FAILED(renderResult == nullptr ? E_NOINTERFACE : S_OK);
...
HRESULT AdaptiveRenderContext::GetInputValue(
    _In_ ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveInputElement* inputElement,
...
HRESULT AdaptiveRenderContext::get_TextStyle(_Outptr_ ABI::Windows::Foundation::IReference<ABI::AdaptiveCards::ObjectModel::Uwp::TextStyle>** textStyle)
{
