...
//
//        HRESULT RuntimeClassInitialize(_In_ ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveCardElement*
//        cardElement,
...
//        ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveCardElement** cardElement) override; virtual HRESULT
