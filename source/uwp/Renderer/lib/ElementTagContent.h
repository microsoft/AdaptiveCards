...
namespace AdaptiveCards::Rendering::Uwp
{
    ...
    public:
        ...
        virtual HRESULT get_AdaptiveCardElement(_COM_Outptr_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveCardElement *
                                                *cardElement) = 0;
    ...
    public:
        ...
        HRESULT RuntimeClassInitialize(_In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveCardElement* cardElement,
        ...
        virtual HRESULT get_AdaptiveCardElement(_COM_Outptr_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveCardElement** cardElement) override;
