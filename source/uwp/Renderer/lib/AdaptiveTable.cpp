...
namespace AdaptiveCards::Rendering::Uwp
{
    ...
    {
        m_rows = Microsoft::WRL::Make<Vector<ABI::AdaptiveCards::Rendering::Uwp::AdaptiveTableRow*>>();
        m_columnDefinitions =
            Microsoft::WRL::Make<Vector<ABI::AdaptiveCards::Rendering::Uwp::AdaptiveTableColumnDefinition*>>();
    }
    ...
    HRESULT AdaptiveTable::get_ElementType(ABI::AdaptiveCards::Rendering::Uwp::ElementType* elementType)
    {
        *elementType = ElementType::Table;
        return S_OK;
    }

    HRESULT AdaptiveTable::get_Rows(ABI::Windows::Foundation::Collections::IVector<ABI::AdaptiveCards::Rendering::Uwp::AdaptiveTableRow*>** rows)
    {
        return m_rows.CopyTo(rows);
    }

    HRESULT AdaptiveTable::get_Columns(
        ABI::Windows::Foundation::Collections::IVector<ABI::AdaptiveCards::Rendering::Uwp::AdaptiveTableColumnDefinition*>** columns)
    {
    ...
    HRESULT AdaptiveTable::get_GridStyle(ABI::AdaptiveCards::Rendering::Uwp::ContainerStyle* gridStyle)
    {
        *gridStyle = m_gridStyle;
        return S_OK;
    }

    HRESULT AdaptiveTable::put_GridStyle(ABI::AdaptiveCards::Rendering::Uwp::ContainerStyle gridStyle)
    {
