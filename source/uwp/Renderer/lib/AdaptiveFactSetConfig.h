...
namespace AdaptiveCards::Rendering::Uwp
{
    ...
    public:
        ...
        IFACEMETHODIMP get_Title(_COM_Outptr_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveTextConfig** titleTextConfig);
        IFACEMETHODIMP put_Title(_In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveTextConfig* titleTextConfig);

        IFACEMETHODIMP get_Value(_COM_Outptr_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveTextConfig** valueTextConfig);
