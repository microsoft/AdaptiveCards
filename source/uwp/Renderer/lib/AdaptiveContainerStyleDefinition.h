...
AdaptiveNamespaceStart
    class AdaptiveContainerStyleDefinition :
        public Microsoft::WRL::RuntimeClass<
            ...
            ABI::AdaptiveNamespaceRef::IAdaptiveContainerStyleDefinition>
    {
    ...
    public:
        ...
        IFACEMETHODIMP get_ForegroundColors(_Out_ ABI::AdaptiveNamespaceRef::IAdaptiveColorsConfig** colorsConfig);
        IFACEMETHODIMP put_ForegroundColors(_In_ ABI::AdaptiveNamespaceRef::IAdaptiveColorsConfig* colorsConfig);

    private:
        ABI::Windows::UI::Color m_backgroundColor;
        Microsoft::WRL::ComPtr<ABI::AdaptiveNamespaceRef::IAdaptiveColorsConfig> m_foregroundColors;
    };
