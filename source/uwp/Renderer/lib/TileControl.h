...
class DECLSPEC_UUID("0F485063-EF2A-400E-A946-73E00EDFAC83") TileControl
    : public Microsoft::WRL::RuntimeClass<
          ABI::AdaptiveCards::Rendering::Uwp::ITileControl,
...
public:
    ...
    virtual HRESULT STDMETHODCALLTYPE get_RootElement(_Outptr_ IFrameworkElement** /*value*/)
    {
        return E_NOTIMPL;
    }
    virtual HRESULT STDMETHODCALLTYPE put_ResolvedImage(_In_ IUIElement* /*value*/)
    {
        return E_NOTIMPL;
    }
...
private:
    ...
    HRESULT ExtractBackgroundImageData(
        _Out_ ABI::AdaptiveCards::ObjectModel::Uwp::BackgroundImageFillMode* fillMode,
