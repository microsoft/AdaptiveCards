...
template <typename T>
Microsoft::WRL::ComPtr<T> CreateABIClass(Microsoft::WRL::Wrappers::HStringReference className)
{
...
HRESULT SetStyleFromResourceDictionary(
...
Microsoft::WRL::ComPtr<ABI::Windows::UI::Xaml::IUIElement> CreateSeparator(
    _In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveRenderContext* renderContext,
    UINT spacing,
...
template <typename T>
HRESULT TryGetResourceFromResourceDictionaries(
    _In_ ABI::Windows::UI::Xaml::IResourceDictionary* resourceDictionary, HSTRING resourceName, _COM_Outptr_result_maybenull_ T** style) noexcept
{
    ...
    *style = nullptr;
    try
    {
        ...
        boolean hasKey{};
        if (SUCCEEDED(strongDictionary.As(&resourceDictionaryMap)) && SUCCEEDED(resourceDictionaryMap->HasKey(resourceKey.Get(), &hasKey)) &&
...
template <typename T>
HRESULT TryGetResourceFromResourceDictionaries(
    _In_ ABI::Windows::UI::Xaml::IResourceDictionary* resourceDictionary, const wchar_t* resourceName, _COM_Outptr_result_maybenull_ T** style) noexcept
{
...
HRESULT HandleColumnWidth(
    _In_ ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveColumn* column,
    boolean isVisible,
    _In_ ABI::Windows::UI::Xaml::Controls::IColumnDefinition* columnDefinition);

HRESULT HandleTableColumnWidth(
    _In_ ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveTableColumnDefinition* column,
    _In_ ABI::Windows::UI::Xaml::Controls::IColumnDefinition* columnDefinition);

template <typename T>
void AppendXamlElementToPanel(
    _In_ T* xamlElement,
...
template <typename T>
void SetToggleValue(_In_ T* item, boolean isChecked)
{
    ComPtr<IPropertyValueStatics> propertyValueStatics;
...
template <typename T>
void GetToggleValue(_In_ T* item, _Out_ boolean* isChecked)
{
    ComPtr<T> localItem(item);
    ComPtr<IToggleButton> toggleButton;
    THROW_IF_FAILED(localItem.As(&toggleButton));
...
void SetContent(winrt::Windows::UI::Xaml::Controls::IContentControl contentControl, _In_ winrt::param::hstring contentString, boolean wrap = false);

template <typename T>
void SetContent(_In_ T* item, _In_ HSTRING contentString, boolean wrap)
{
    ComPtr<T> localItem(item);
    ComPtr<IContentControl> contentControl;
    THROW_IF_FAILED(localItem.As(&contentControl));

    ComPtr<ITextBlock> content = XamlHelpers::CreateABIClass<ITextBlock>(HStringReference(RuntimeClass_Windows_UI_Xaml_Controls_TextBlock));
...
HRESULT HandleStylingAndPadding(
    _In_ ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveContainerBase* adaptiveContainer,
...
HRESULT RenderInputErrorMessage(
    ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveInputElement* adaptiveInputElement,
...
HRESULT CreateValidationBorder(
    ABI::Windows::UI::Xaml::IUIElement* childElement,
    ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveRenderContext* renderContext,
    ABI::Windows::UI::Xaml::Controls::IBorder** elementWithBorder);

HRESULT HandleLabelAndErrorMessage(
    _In_ ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveInputElement* adaptiveInput,
    _In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveRenderContext* renderContext,
    _In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveRenderArgs* renderArgs,
    _Out_ ABI::Windows::UI::Xaml::IUIElement** inputLayout);

HRESULT HandleInputLayoutAndValidation(
    ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveInputElement* adaptiveInput,
...
HRESULT SetXamlHeaderFromLabel(
    _In_ ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveInputElement* adaptiveInputElement,
    _In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveRenderContext* renderContext,
    _In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveRenderArgs* renderArgs,
...
HRESULT AddRenderedControl(
    _In_ ABI::Windows::UI::Xaml::IUIElement* newControl,
...
HRESULT RenderFallback(
    _In_ ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveCardElement* currentElement,
    _In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveRenderContext* renderContext,
    _In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveRenderArgs* renderArgs,
...
inline HRESULT WarnFallbackString(_In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveRenderContext* renderContext, const std::string& warning)
{
    HString warningMsg;
    RETURN_IF_FAILED(UTF8ToHString(warning, warningMsg.GetAddressOf()));

    RETURN_IF_FAILED(
        renderContext->AddWarning(ABI::AdaptiveCards::ObjectModel::Uwp::WarningStatusCode::PerformingFallback, warningMsg.Get()));
    return S_OK;
}

inline HRESULT WarnForFallbackContentElement(
    _In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveRenderContext* renderContext, _In_ HSTRING parentElementType, _In_ HSTRING fallbackElementType)
try
{
...
inline HRESULT WarnForFallbackDrop(_In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveRenderContext* renderContext, _In_ HSTRING elementType)
try
{
...
HRESULT ApplyMarginToXamlElement(
    _In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveHostConfig* hostConfig, _In_ ABI::Windows::UI::Xaml::IFrameworkElement* element) noexcept;
} // namespace AdaptiveCards::Rendering::Uwp::XamlHelpers
