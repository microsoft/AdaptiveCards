...
namespace AdaptiveNamespace
{
    ...
    public:
        ...
        static HRESULT BuildXamlTreeFromAdaptiveCard(
            ...
            _In_ Microsoft::WRL::ComPtr<XamlBuilder> xamlBuilder,
    ...
    private:
        ...
        static HRESULT BuildShowCard(ABI::AdaptiveNamespace::IAdaptiveShowCardActionConfig* showCardActionConfig,
                                     _In_ ABI::AdaptiveNamespace::IAdaptiveActionElement* action,
                                     _In_ ABI::AdaptiveNamespace::IAdaptiveRenderContext* renderContext,
                                     bool isBottomActionBar,
                                     _COM_Outptr_ ABI::Windows::UI::Xaml::IUIElement** uiShowCard);
        ...
        static HRESULT BuildActionSetHelper(ABI::Windows::Foundation::Collections::IVector<ABI::AdaptiveNamespace::IAdaptiveActionElement*>* children,
