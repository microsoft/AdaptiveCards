...
class XamlBuilder
    : public Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<Microsoft::WRL::RuntimeClassType::WinRtClassicComMix>, Microsoft::WRL::FtmBase, AdaptiveCards::Rendering::Uwp::IImageLoadTrackerListener>
{
...
public:
    ...
    static HRESULT BuildXamlTreeFromAdaptiveCard(
        ...
        ABI::AdaptiveCards::ObjectModel::Uwp::ContainerStyle defaultContainerStyle = ABI::AdaptiveCards::ObjectModel::Uwp::ContainerStyle::Default) noexcept;
...
private:
    ...
    static HRESULT CreateRootCardElement(
        _In_ ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveCard* adaptiveCard,
        _In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveRenderContext* renderContext,
        _In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveRenderArgs* renderArgs,
        Microsoft::WRL::ComPtr<XamlBuilder> xamlBuilder,
