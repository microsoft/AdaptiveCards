...
namespace AdaptiveCards { namespace XamlCardRenderer
{
    ...
    public:
        ...
        IFACEMETHODIMP get_BorderThickness(_Out_ ABI::AdaptiveCards::XamlCardRenderer::IAdaptiveBoundaryOptions** value);
        IFACEMETHODIMP put_BorderThickness(_In_ ABI::AdaptiveCards::XamlCardRenderer::IAdaptiveBoundaryOptions* value);
