...
{
    HRESULT BuildAction(_In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveActionElement* adaptiveActionElement,
    ...
    void ArrangeButtonContent(_In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveActionElement* action,
    ...
    HRESULT HandleActionStyling(_In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveActionElement* adaptiveActionElement,
    ...
    void HandleInlineAction(_In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveRenderContext* renderContext,
                            ...
                            _In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveActionElement* inlineAction,
    ...
    void WrapInTouchTarget(_In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveCardElement* adaptiveCardElement,
                           _In_ ABI::Windows::UI::Xaml::IUIElement* elementToWrap,
                           _In_opt_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveActionElement* action,
                           _In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveRenderContext* renderContext,
                           bool fullWidth,
    ...
    void HandleSelectAction(_In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveCardElement* adaptiveCardElement,
    ...
    HRESULT BuildActions(_In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveCard* adaptiveCard,
    ...
    HRESULT BuildActionSetHelper(_In_opt_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveCard* adaptiveCard,
                                 _In_opt_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveActionSet* adaptiveActionSet,
                                 _In_ ABI::Windows::Foundation::Collections::IVector<ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveActionElement*>* children,
                                 _In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveRenderContext* renderContext,
                                 _In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveRenderArgs* renderArgs,
                                 _Outptr_ ABI::Windows::UI::Xaml::IUIElement** actionSetControl);

    void CreateAppropriateButton(_In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveActionElement* action,
