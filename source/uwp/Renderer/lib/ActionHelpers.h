...
HRESULT BuildAction(
    _In_ ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveActionElement* adaptiveActionElement,
    _In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveRenderContext* renderContext,
    _In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveRenderArgs* renderArgs,
    bool isOverflowActionButton,
    _Outptr_ ABI::Windows::UI::Xaml::IUIElement** actionControl);

HRESULT GetButtonMargin(_In_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveActionsConfig* actionsConfig, ABI::Windows::UI::Xaml::Thickness& buttonMargin) noexcept;
...
HRESULT SetMatchingHeight(_In_ ABI::Windows::UI::Xaml::IFrameworkElement* elementToChange, _In_ ABI::Windows::UI::Xaml::IFrameworkElement* elementToMatch);
...
void WrapInTouchTarget(
    _In_ ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveCardElement* adaptiveCardElement,
