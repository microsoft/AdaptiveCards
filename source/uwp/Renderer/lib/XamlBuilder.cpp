...
namespace AdaptiveNamespace
{
    ...
    HRESULT XamlBuilder::BuildXamlTreeFromAdaptiveCard(_In_ IAdaptiveCard* adaptiveCard,
                                                       _COM_Outptr_ IFrameworkElement** xamlTreeRoot,
                                                       _In_ IAdaptiveRenderContext* renderContext,
                                                       _In_ ComPtr<XamlBuilder> xamlBuilder,
                                                       boolean isOuterCard,
                                                       ABI::AdaptiveNamespace::ContainerStyle defaultContainerStyle)
    {
        *xamlTreeRoot = nullptr;
        if (adaptiveCard != nullptr)
        {
            ...
            RETURN_IF_FAILED(contextImpl->put_CardFrameworkElement(rootAsFrameworkElement.Get()));
    ...
    HRESULT XamlBuilder::BuildShowCard(_In_ IAdaptiveShowCardActionConfig* showCardActionConfig,
                                       _In_ IAdaptiveActionElement* action,
                                       _In_ IAdaptiveRenderContext* renderContext,
                                       bool isBottomActionBar,
                                       _COM_Outptr_ IUIElement** uiShowCard)
    {
        ...
        RETURN_IF_FAILED(localAction.As(&showCardAction));
        ...
        RETURN_IF_FAILED(showCardAction->get_Card(showCard.GetAddressOf()));

        ComPtr<IFrameworkElement> localUiShowCard;
        RETURN_IF_FAILED(BuildXamlTreeFromAdaptiveCard(
            showCard.Get(), localUiShowCard.GetAddressOf(), localRenderContext.Get(), nullptr, false, showCardConfigStyle));
                                        ...
                                        _COM_Outptr_ IUIElement** actionSetControl)
    {
        ...
        return BuildActionSetHelper(actions.Get(), renderContext, false, actionSetControl, containerStyle);
    }
                                      ...
                                      ABI::AdaptiveNamespace::ContainerStyle containerStyle)
    {
        ...
        RETURN_IF_FAILED(BuildActionSetHelper(children, renderContext, true, &actionSetControl, containerStyle));

        XamlHelpers::AppendXamlElementToPanel(actionSetControl.Get(), bodyPanel);
        return S_OK;
    }

    HRESULT XamlBuilder::BuildActionSetHelper(IVector<IAdaptiveActionElement*>* children,
                                              ...
                                              ABI::AdaptiveNamespace::ContainerStyle containerStyle)
    {
        ...
        XamlHelpers::IterateOverVector<IAdaptiveActionElement>(children, [&](IAdaptiveActionElement* child) {
            if (currentAction < maxActions)
            {
                ...
                RETURN_IF_FAILED(strongRenderContext->get_ActionInvoker(&actionInvoker));
                ...
                RETURN_IF_FAILED(action->get_Sentiment(actionSentiment.GetAddressOf()));
