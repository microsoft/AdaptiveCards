...
class AdaptiveCardResourceResolvers
    : public Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<Microsoft::WRL::RuntimeClassType::WinRtClassicComMix>, ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveCardResourceResolvers>
{
...
public:
    ...
    IFACEMETHODIMP Get(_In_ HSTRING scheme, _COM_Outptr_ ABI::AdaptiveCards::Rendering::Uwp::IAdaptiveCardResourceResolver** resolver);
