...
{
HRESULT AdaptiveHostConfigStaticsImpl::FromJsonString(_In_ HSTRING adaptiveJson, _COM_Outptr_ IAdaptiveHostConfigParseResult** parseResult) noexcept
try
{
    *parseResult = nullptr;
...
HRESULT AdaptiveHostConfigStaticsImpl::FromJson(_In_ IJsonObject* adaptiveJson, _COM_Outptr_ IAdaptiveHostConfigParseResult** parseResult) noexcept
try
{
    *parseResult = nullptr;
...
HRESULT AdaptiveHostConfigStaticsImpl::_FromJsonString(const std::string& jsonString, _COM_Outptr_ IAdaptiveHostConfigParseResult** parseResult)
{
...
HRESULT AdaptiveHostConfig::RuntimeClassInitialize(const HostConfig& sharedHostConfig)
{
    ...
    RETURN_IF_FAILED(MakeAndInitialize<AdaptiveContainerStylesDefinition>(
        m_containerStyles.GetAddressOf(), sharedHostConfig.GetContainerStyles()));
...
HRESULT AdaptiveHostConfig::get_FontFamily(_Outptr_ HSTRING* text)
{
    return m_fontFamily.CopyTo(text);
}

HRESULT AdaptiveHostConfig::put_FontFamily(_In_ HSTRING text)
{
...
HRESULT AdaptiveHostConfig::put_ImageBaseUrl(_In_ HSTRING imageBaseUrl)
{
