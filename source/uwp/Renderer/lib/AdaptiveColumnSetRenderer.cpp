...
AdaptiveNamespaceStart
    ...
    {
        return AdaptiveNamespaceRef::FromJson<AdaptiveNamespaceRef::AdaptiveColumnSet, AdaptiveCards::ColumnSet, AdaptiveCards::ColumnSetParser>(jsonObject, elementParserRegistration, actionParserRegistration, element);
    }
