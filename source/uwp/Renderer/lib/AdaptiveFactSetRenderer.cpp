...
AdaptiveNamespaceStart
    ...
    {
        return AdaptiveNamespaceRef::FromJson<AdaptiveNamespaceRef::AdaptiveFactSet, AdaptiveCards::FactSet, AdaptiveCards::FactSetParser>(jsonObject, elementParserRegistration, actionParserRegistration, element);
    }
