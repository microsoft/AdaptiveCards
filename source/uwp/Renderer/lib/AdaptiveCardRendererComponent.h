...
class AdaptiveCardRenderer : public Microsoft::WRL::RuntimeClass<
...
public:
    ...
    IFACEMETHODIMP RenderAdaptiveCard(
    ...
    IFACEMETHODIMP RenderAdaptiveCardFromJsonString(
        _In_ HSTRING adaptiveJson, _COM_Outptr_ ABI::AdaptiveCards::Rendering::Uwp::IRenderedAdaptiveCard** result) override;

    IFACEMETHODIMP RenderAdaptiveCardFromJson(
