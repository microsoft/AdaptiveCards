...
HRESULT AdaptiveInputs::LinkSubmitActionToCard(
...
void AdaptiveInputs::GetInputsToValidate(_In_ IAdaptiveActionElement* action, _Out_ std::vector<ComPtr<IAdaptiveInputValue>>& inputsToValidate)
{
    ComPtr<IAdaptiveActionElement> localAction(action);
    UINT32 actionId;
