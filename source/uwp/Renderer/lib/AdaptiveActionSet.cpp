...
namespace AdaptiveCards
{
    namespace Rendering
    {
        namespace Uwp
        {
            ...
            _Use_decl_annotations_ HRESULT AdaptiveActionSet::RuntimeClassInitialize(const std::shared_ptr<AdaptiveCards::ActionSet>& sharedActionSet) try
            {
                ...
                m_orientation =
                    static_cast<ABI::AdaptiveCards::Rendering::Uwp::ActionsOrientation>(sharedActionSet->GetOrientation());
            ...
            _Use_decl_annotations_ HRESULT AdaptiveActionSet::get_Orientation(ABI::AdaptiveCards::Rendering::Uwp::ActionsOrientation* orientation)
            {
                *orientation = m_orientation;
                return S_OK;
            }

            _Use_decl_annotations_ HRESULT AdaptiveActionSet::put_Orientation(ABI::AdaptiveCards::Rendering::Uwp::ActionsOrientation orientation)
            {
