    ...
    _COM_Outptr_ IUIElement** imageControl)
{
    ...
    if (imageUrl == nullptr)
    {
        renderContext->AddWarning(
            ABI::AdaptiveCards::ObjectModel::Uwp::WarningStatusCode::AssetLoadFailed,
    ...
    *mustHideElement = true;
    ...
    if (isDataUriImage == 0)
    {
        ...
        THROW_IF_FAILED(GetActivationFactory(
            HStringReference(RuntimeClass_Windows_Storage_Streams_Buffer).Get(), bufferFactory.GetAddressOf()));
