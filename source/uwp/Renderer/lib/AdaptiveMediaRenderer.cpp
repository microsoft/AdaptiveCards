...
try
{
    ...
    if (allowInlinePlayback)
    {
        ...
        mediaElement = XamlHelpers::CreateABIClass<IMediaElement>(HStringReference(RuntimeClass_Windows_UI_Xaml_Controls_MediaElement));
        ...
        {
            renderContext->AddWarning(
                ABI::AdaptiveCards::ObjectModel::Uwp::WarningStatusCode::UnsupportedMediaType,
