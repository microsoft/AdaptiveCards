...
namespace AdaptiveCards { namespace Rendering { namespace Uwp
{
    ...
    {
        return AdaptiveCards::Rendering::Uwp::FromJson<AdaptiveCards::Rendering::Uwp::AdaptiveNumberInput, AdaptiveCards::NumberInput, AdaptiveCards::NumberInputParser>(jsonObject, elementParserRegistration, actionParserRegistration, element);
    }
}}}
