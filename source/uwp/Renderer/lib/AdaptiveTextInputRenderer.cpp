...
{
    ComPtr<ITextBox> textBox = XamlHelpers::CreateABIClass<ITextBox>(HStringReference(RuntimeClass_Windows_UI_Xaml_Controls_TextBox));
    ...
    _COM_Outptr_ IUIElement** textInputControl)
{
    ...
    RETURN_IF_FAILED(MakeAndInitialize<PasswordInputValue>(&inputValue, adaptiveTextInput, passwordBox.Get(), validationBorder.Get()));
    RETURN_IF_FAILED(renderContext->AddInputValue(inputValue.Get(), renderArgs));
