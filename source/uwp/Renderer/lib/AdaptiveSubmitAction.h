...
namespace AdaptiveNamespace
{
    ...
    public:
        ...
        IFACEMETHODIMP get_Sentiment(_Out_ HSTRING* sentiment) { return AdaptiveActionElementBase::get_Sentiment(sentiment); }
        IFACEMETHODIMP put_Sentiment(_In_ HSTRING sentiment) { return AdaptiveActionElementBase::put_Sentiment(sentiment); }
