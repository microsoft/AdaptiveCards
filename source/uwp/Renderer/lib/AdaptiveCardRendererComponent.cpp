...
HRESULT AdaptiveCardRenderer::RenderAdaptiveCard(_In_ IAdaptiveCard* adaptiveCard, _COM_Outptr_ IRenderedAdaptiveCard** result)
{
    ...
    if (adaptiveCard)
    {
        ...
        try
        {
            ...
            AdaptiveCards::Rendering::Uwp::XamlBuilder::BuildXamlTreeFromAdaptiveCard(
                adaptiveCard, &xamlTreeRoot, renderContext.Get(), m_xamlBuilder);
...
HRESULT AdaptiveCardRenderer::RenderAdaptiveCardFromJsonString(_In_ HSTRING adaptiveJson, _COM_Outptr_ IRenderedAdaptiveCard** result)
{
    ...
    RETURN_IF_FAILED(GetActivationFactory(
        HStringReference(RuntimeClass_AdaptiveCards_ObjectModel_Uwp_AdaptiveCard).Get(), &adaptiveCardStatics));
...
void AdaptiveCardRenderer::UpdateActionSentimentResourceDictionary()
{
    ...
    THROW_IF_FAILED(TryInsertResourceToSentimentResourceDictionary(
        L"Adaptive.Action.Positive.Button.Static.Background", accentColorBrush.Get()));
    ...
    THROW_IF_FAILED(TryInsertResourceToSentimentResourceDictionary(
        L"Adaptive.Action.Destructive.Button.Foreground", attentionColorBrush.Get()));
