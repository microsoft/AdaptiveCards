...
HRESULT AdaptiveCardRenderer::RenderAdaptiveCard(_In_ IAdaptiveCard* adaptiveCard, _COM_Outptr_ IRenderedAdaptiveCard** result)
{
    ...
    if (adaptiveCard)
    {
        ...
        try
        {
            ...
            AdaptiveCards::Rendering::Uwp::XamlBuilder::BuildXamlTreeFromAdaptiveCard(adaptiveCard, &xamlTreeRoot, renderContext.Get(), m_xamlBuilder);
...
HRESULT AdaptiveCardRenderer::RenderAdaptiveCardFromJsonString(_In_ HSTRING adaptiveJson, _COM_Outptr_ IRenderedAdaptiveCard** result)
{
    ComPtr<::AdaptiveCards::Rendering::Uwp::RenderedAdaptiveCard> renderedCard;
    RETURN_IF_FAILED(MakeAndInitialize<::AdaptiveCards::Rendering::Uwp::RenderedAdaptiveCard>(&renderedCard));
    ...
    RETURN_IF_FAILED(GetActivationFactory(HStringReference(RuntimeClass_AdaptiveCards_ObjectModel_Uwp_AdaptiveCard).Get(), &adaptiveCardStatics));
...
HRESULT AdaptiveCardRenderer::RenderAdaptiveCardFromJson(_In_ IJsonObject* adaptiveJson, _COM_Outptr_ IRenderedAdaptiveCard** result)
{
...
void AdaptiveCardRenderer::InitializeDefaultResourceDictionary()
{
    ...
    THROW_IF_FAILED(xamlReaderStatics->Load(
        HStringReference(c_defaultActionSentimentResourceDictionary).Get(), &actionSentimentResourceDictionaryInspectable));
...
HRESULT AdaptiveCardRenderer::TryInsertResourceToSentimentResourceDictionary(const std::wstring& resourceName, _In_ IInspectable* value)
{
    ComPtr<IPropertyValueStatics> propertyValueStatics;
    RETURN_IF_FAILED(GetActivationFactory(HStringReference(RuntimeClass_Windows_Foundation_PropertyValue).Get(), &propertyValueStatics));
...
void AdaptiveCardRenderer::UpdateActionSentimentResourceDictionary()
{
    ...
    THROW_IF_FAILED(GetColorFromAdaptiveColor(
        m_hostConfig.Get(),
    ...
    THROW_IF_FAILED(
        TryInsertResourceToSentimentResourceDictionary(L"Adaptive.Action.Positive.Button.Static.Background", accentColorBrush.Get()));

    ComPtr<IBrush> lightAccentColorBrush = XamlHelpers::GetSolidColorBrush(hoverAccentColor);
    THROW_IF_FAILED(TryInsertResourceToSentimentResourceDictionary(
        L"Adaptive.Action.Positive.Button.MouseOver.Background", lightAccentColorBrush.Get()));

    ComPtr<IBrush> attentionColorBrush = XamlHelpers::GetSolidColorBrush(attentionColor);
    THROW_IF_FAILED(
        TryInsertResourceToSentimentResourceDictionary(L"Adaptive.Action.Destructive.Button.Foreground", attentionColorBrush.Get()));

    ComPtr<IBrush> lightAttentionColorBrush = XamlHelpers::GetSolidColorBrush(hoverAttentionColor);
    THROW_IF_FAILED(TryInsertResourceToSentimentResourceDictionary(
        L"Adaptive.Action.Destructive.Button.MouseOver.Foreground", lightAttentionColorBrush.Get()));
}
...
ComPtr<XamlBuilder> AdaptiveCardRenderer::GetXamlBuilder()
{
