...
HRESULT WholeItemsPanel::RuntimeClassInitialize()
{
    ...
    RETURN_IF_FAILED(Windows::Foundation::GetActivationFactory(
        HStringReference(RuntimeClass_Windows_UI_Xaml_Controls_Panel).Get(), &spFactory));
    RETURN_IF_FAILED(spFactory->CreateInstance(
        static_cast<IWholeItemsPanel*>(this), spInnerInspectable.GetAddressOf(), spInnerPanel.GetAddressOf()));
...
HRESULT WholeItemsPanel::ArrangeOverride(Size finalSize, __RPC__out Size* returnValue)
{
    ...
    RETURN_IF_FAILED(Windows::Foundation::ActivateInstance(
        HStringReference(RuntimeClass_Windows_UI_Xaml_Media_RectangleGeometry).Get(), &spClip));
...
_Check_return_ HRESULT WholeItemsPanel::IsAnySubgroupTruncated(_In_ ABI::Windows::UI::Xaml::Controls::IPanel* pPanel, _Out_ bool* childTruncated)
{
    ...
    *pResult = nullptr;
    ...
    if (SUCCEEDED(pElement->QueryInterface(spDependencyObject.GetAddressOf())))
    {
        ...
        RETURN_IF_FAILED(::GetActivationFactory(
            HStringReference(RuntimeClass_Windows_UI_Xaml_Automation_AutomationProperties).Get(), &automationStatics));
