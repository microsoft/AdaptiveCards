...
namespace AdaptiveNamespace
{
    ...
    _Use_decl_annotations_ HRESULT AdaptiveCardStaticsImpl::FromJsonWithFrame(IJsonObject* adaptiveJson,
                                                                              ...
                                                                              IAdaptiveCardParseResult** parseResult) noexcept try
    {
        ...
        return FromJsonStringWithFrame(adaptiveJsonString, adaptiveFrameString, nullptr, nullptr, parseResult);
    }
    CATCH_RETURN;
    ...
    {
        std::string jsonFrame;
        return FromJsonStringWithFrame(jsonString, jsonFrame, elementParserRegistration, actionParserRegistration, parseResult);
    }

    _Use_decl_annotations_ HRESULT AdaptiveCardStaticsImpl::FromJsonStringWithFrame(const std::string jsonString,
                                                                                    ...
                                                                                    IAdaptiveCardParseResult** parseResult)
    {
        ...
        try
        {
            ...
            if (jsonFrame.empty())
            {
                sharedParseResult = ::AdaptiveCards::AdaptiveCard::DeserializeFromString(jsonString,
                                                                                         c_rendererVersion,
            ...
            {
                sharedParseResult = ::AdaptiveCards::AdaptiveCard::DeserializeFromStringWithFrame(
                    jsonString, jsonFrame, c_rendererVersion, sharedModelElementParserRegistration, sharedModelActionParserRegistration);
            }
