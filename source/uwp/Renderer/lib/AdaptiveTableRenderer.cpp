    ...
    _COM_Outptr_ IFrameworkElement** renderedCell)
{
    ...
    if (showGridLines)
    {
        ...
        ComPtr<IBorder> cellBorder = XamlHelpers::CreateABIClass<IBorder>(HStringReference(RuntimeClass_Windows_UI_Xaml_Controls_Border));
...
HRESULT AdaptiveTableRenderer::Render(
...
try
{
    ...
    IterateOverVectorWithFailure<AdaptiveTableColumnDefinition, IAdaptiveTableColumnDefinition>(
        columns.Get(), true, [&](IAdaptiveTableColumnDefinition* column) {
            ComPtr<IColumnDefinition> xamlColumnDefinition =
