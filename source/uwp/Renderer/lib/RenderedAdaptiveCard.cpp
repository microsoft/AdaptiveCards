    ...
    while (SUCCEEDED(hr) && hasCurrent)
    {
        ...
        if (toggleElement != nullptr)
        {
            ...
            if (SUCCEEDED(cardElement.As(&cardElementAsColumn)))
            {
                ...
                RETURN_IF_FAILED(XamlHelpers::HandleColumnWidth(
                    cardElementAsColumn.Get(), (visibilityToSet == Visibility_Visible), columnDefinition.Get()));
            }
        }
...
HRESULT RenderedAdaptiveCard::AddInlineShowCard(
    _In_ IAdaptiveActionSet* actionSet,
...
HRESULT RenderedAdaptiveCard::AddInlineShowCardHelper(
    UINT32 actionSetId,
...
HRESULT RenderedAdaptiveCard::AddOverflowButton(
...
HRESULT RenderedAdaptiveCard::LinkActionToCard(
...
HRESULT RenderedAdaptiveCard::LinkCardToParent(
...
HRESULT RenderedAdaptiveCard::GetInputValue(
