...
AdaptiveNamespaceStart
    ...
    {
        return AdaptiveNamespaceRef::FromJson<AdaptiveNamespaceRef::AdaptiveTimeInput, AdaptiveCards::TimeInput, AdaptiveCards::TimeInputParser>(jsonObject, elementParserRegistration, actionParserRegistration, element);
    }
