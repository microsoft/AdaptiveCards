...
namespace AdaptiveNamespace
{
    ...
    public:
        ...
        IFACEMETHODIMP get_Default(_Outptr_ ABI::AdaptiveNamespace::IAdaptiveFontStyleDefinition** value);
        IFACEMETHODIMP put_Default(_In_ ABI::AdaptiveNamespace::IAdaptiveFontStyleDefinition* value);

        IFACEMETHODIMP get_Display(_Outptr_ ABI::AdaptiveNamespace::IAdaptiveFontStyleDefinition** value);
        IFACEMETHODIMP put_Display(_In_ ABI::AdaptiveNamespace::IAdaptiveFontStyleDefinition* value);

        IFACEMETHODIMP get_Monospace(_Outptr_ ABI::AdaptiveNamespace::IAdaptiveFontStyleDefinition** value);
