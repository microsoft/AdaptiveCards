...
AdaptiveNamespaceStart
    ...
    {
        return AdaptiveNamespaceRef::FromJson<AdaptiveNamespaceRef::AdaptiveDateInput, AdaptiveCards::DateInput, AdaptiveCards::DateInputParser>(jsonObject, elementParserRegistration, actionParserRegistration, element);
    }
