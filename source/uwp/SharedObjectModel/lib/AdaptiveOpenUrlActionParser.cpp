...
{
    winrt::AdaptiveCards::ObjectModel::Xaml_OM::IAdaptiveActionElement AdaptiveOpenUrlActionParser::FromJson(
    ...
    {
        return ::AdaptiveCards::ObjectModel::Xaml_OM::FromJson<implementation::AdaptiveOpenUrlAction, ::AdaptiveCards::OpenUrlAction, ::AdaptiveCards::OpenUrlActionParser>(
