...
{
    winrt::AdaptiveCards::ObjectModel::Xaml_OM::IAdaptiveCardElement AdaptiveTimeInputParser::FromJson(
    ...
    {
        return ::AdaptiveCards::ObjectModel::Xaml_OM::FromJson<implementation::AdaptiveTimeInput, ::AdaptiveCards::TimeInput, ::AdaptiveCards::TimeInputParser>(
