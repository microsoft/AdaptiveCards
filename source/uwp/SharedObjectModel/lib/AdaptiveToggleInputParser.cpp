...
{
    winrt::AdaptiveCards::ObjectModel::Xaml_OM::IAdaptiveCardElement AdaptiveToggleInputParser::FromJson(
    ...
    {
        return ::AdaptiveCards::ObjectModel::Xaml_OM::FromJson<implementation::AdaptiveToggleInput, ::AdaptiveCards::ToggleInput, ::AdaptiveCards::ToggleInputParser>(
