...
{
    winrt::AdaptiveCards::ObjectModel::Xaml_OM::IAdaptiveCardElement AdaptiveDateInputParser::FromJson(
    ...
    {
        return ::AdaptiveCards::ObjectModel::Xaml_OM::FromJson<implementation::AdaptiveDateInput, ::AdaptiveCards::DateInput, ::AdaptiveCards::DateInputParser>(
