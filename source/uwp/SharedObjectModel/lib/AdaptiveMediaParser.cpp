...
{
    winrt::AdaptiveCards::ObjectModel::Xaml_OM::IAdaptiveCardElement AdaptiveMediaParser::FromJson(
    ...
    {
        return ::AdaptiveCards::ObjectModel::Xaml_OM::FromJson<implementation::AdaptiveMedia, ::AdaptiveCards::Media, ::AdaptiveCards::MediaParser>(
