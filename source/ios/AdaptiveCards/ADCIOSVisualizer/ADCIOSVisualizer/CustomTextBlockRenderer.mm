        ...
        hostConfig:(ACOHostConfig *)acoConfig
{
    ...
    std::shared_ptr<MarkDownParser> markDownParser = std::make_shared<MarkDownParser>([ACOHostConfig getLocalizedDate:(std::string)textBlockElement->GetText():(std::string)textBlockElement->GetLanguage()]);
