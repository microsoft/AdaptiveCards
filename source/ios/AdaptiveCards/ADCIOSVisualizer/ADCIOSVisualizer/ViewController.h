...
@interface ViewController:UIViewController <ACVTableViewControllerDelegate, UITableViewDataSource, UITableViewDelegate, ACRActionDelegate, ACRMediaDelegate, ACRIBaseActionSetRenderer>
