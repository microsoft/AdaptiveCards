...
export class Strings {
    static readonly errors = {
        ...
        propertyMustBeSet: (propertyName: string) =>
        ...
        unsupportedCardVersion: (
            ...
            `The specified card version (${version}) is not supported. The maximum supported card version is ${maxSupportedVersion}.`,
    ...
    static readonly magicCodeInputCard = {
        ...
        pleaseEnterMagicCodeYouReceived: () =>
            "Please enter the magic code you received.",
        submit: () => "Submit",
        cancel: () => "Cancel",
        somethingWentWrong: () =>
            "Something went wrong. This action can't be handled.",
