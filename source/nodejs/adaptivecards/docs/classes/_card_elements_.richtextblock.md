[Adaptive Cards Javascript SDK](../README.md) › ["card-elements"](../modules/_card_elements_.md) › [RichTextBlock](_card_elements_.richtextblock.md)
...
* [customCssSelector](_card_elements_.richtextblock.md#customcssselector)
* [height](_card_elements_.richtextblock.md#height)
* [horizontalAlignment](_card_elements_.richtextblock.md#optional-horizontalalignment)
* [id](_card_elements_.richtextblock.md#id)
* [minPixelHeight](_card_elements_.richtextblock.md#optional-minpixelheight)
* [requires](_card_elements_.richtextblock.md#requires)
* [separator](_card_elements_.richtextblock.md#separator)
* [spacing](_card_elements_.richtextblock.md#spacing)

### Accessors

* [allowCustomPadding](_card_elements_.richtextblock.md#protected-allowcustompadding)
* [defaultStyle](_card_elements_.richtextblock.md#protected-defaultstyle)
* [hasVisibleSeparator](_card_elements_.richtextblock.md#hasvisibleseparator)
* [hostConfig](_card_elements_.richtextblock.md#hostconfig)
* [index](_card_elements_.richtextblock.md#index)
* [isInline](_card_elements_.richtextblock.md#isinline)
* [isInteractive](_card_elements_.richtextblock.md#isinteractive)
* [isStandalone](_card_elements_.richtextblock.md#isstandalone)
* [isVisible](_card_elements_.richtextblock.md#isvisible)
* [lang](_card_elements_.richtextblock.md#lang)
* [parent](_card_elements_.richtextblock.md#parent)
* [renderedElement](_card_elements_.richtextblock.md#renderedelement)
* [separatorElement](_card_elements_.richtextblock.md#separatorelement)
* [separatorOrientation](_card_elements_.richtextblock.md#protected-separatororientation)
* [supportsMinHeight](_card_elements_.richtextblock.md#protected-supportsminheight)
* [useDefaultSizing](_card_elements_.richtextblock.md#protected-usedefaultsizing)

### Methods

* [addInline](_card_elements_.richtextblock.md#addinline)
* [adjustRenderedElementSize](_card_elements_.richtextblock.md#protected-adjustrenderedelementsize)
* [applyPadding](_card_elements_.richtextblock.md#protected-applypadding)
* [asString](_card_elements_.richtextblock.md#asstring)
* [createPlaceholderElement](_card_elements_.richtextblock.md#protected-createplaceholderelement)
* [getActionAt](_card_elements_.richtextblock.md#getactionat)
* [getActionById](_card_elements_.richtextblock.md#getactionbyid)
* [getActionCount](_card_elements_.richtextblock.md#getactioncount)
* [getAllInputs](_card_elements_.richtextblock.md#getallinputs)
* [getCustomProperty](_card_elements_.richtextblock.md#getcustomproperty)
* [getDefaultPadding](_card_elements_.richtextblock.md#protected-getdefaultpadding)
* [getEffectivePadding](_card_elements_.richtextblock.md#geteffectivepadding)
* [getEffectiveStyle](_card_elements_.richtextblock.md#geteffectivestyle)
* [getElementById](_card_elements_.richtextblock.md#getelementbyid)
* [getForbiddenActionTypes](_card_elements_.richtextblock.md#getforbiddenactiontypes)
* [getForbiddenElementTypes](_card_elements_.richtextblock.md#getforbiddenelementtypes)
* [getHasBackground](_card_elements_.richtextblock.md#protected-gethasbackground)
* [getImmediateSurroundingPadding](_card_elements_.richtextblock.md#getimmediatesurroundingpadding)
* [getInlineAt](_card_elements_.richtextblock.md#getinlineat)
* [getInlineCount](_card_elements_.richtextblock.md#getinlinecount)
* [getJsonTypeName](_card_elements_.richtextblock.md#getjsontypename)
* [getPadding](_card_elements_.richtextblock.md#protected-getpadding)
* [getParentContainer](_card_elements_.richtextblock.md#getparentcontainer)
* [getResourceInformation](_card_elements_.richtextblock.md#getresourceinformation)
* [getRootElement](_card_elements_.richtextblock.md#getrootelement)
* [indexOf](_card_elements_.richtextblock.md#indexof)
* [internalRender](_card_elements_.richtextblock.md#protected-internalrender)
* [internalValidateProperties](_card_elements_.richtextblock.md#internalvalidateproperties)
* [isAtTheVeryBottom](_card_elements_.richtextblock.md#isattheverybottom)
* [isAtTheVeryLeft](_card_elements_.richtextblock.md#isattheveryleft)
* [isAtTheVeryRight](_card_elements_.richtextblock.md#isattheveryright)
* [isAtTheVeryTop](_card_elements_.richtextblock.md#isattheverytop)
* [isBleeding](_card_elements_.richtextblock.md#isbleeding)
* [isBleedingAtBottom](_card_elements_.richtextblock.md#isbleedingatbottom)
* [isBleedingAtTop](_card_elements_.richtextblock.md#isbleedingattop)
* [isBottomElement](_card_elements_.richtextblock.md#isbottomelement)
* [isDesignMode](_card_elements_.richtextblock.md#isdesignmode)
* [isFirstElement](_card_elements_.richtextblock.md#isfirstelement)
* [isHiddenDueToOverflow](_card_elements_.richtextblock.md#ishiddenduetooverflow)
* [isLastElement](_card_elements_.richtextblock.md#islastelement)
* [isLeftMostElement](_card_elements_.richtextblock.md#isleftmostelement)
* [isRendered](_card_elements_.richtextblock.md#isrendered)
* [isRightMostElement](_card_elements_.richtextblock.md#isrightmostelement)
* [isTopElement](_card_elements_.richtextblock.md#istopelement)
* [overrideInternalRender](_card_elements_.richtextblock.md#protected-overrideinternalrender)
* [parse](_card_elements_.richtextblock.md#parse)
* [remove](_card_elements_.richtextblock.md#remove)
* [removeInline](_card_elements_.richtextblock.md#removeinline)
* [render](_card_elements_.richtextblock.md#render)
* [setCustomProperty](_card_elements_.richtextblock.md#setcustomproperty)
* [setPadding](_card_elements_.richtextblock.md#protected-setpadding)
* [setParent](_card_elements_.richtextblock.md#setparent)
* [setShouldFallback](_card_elements_.richtextblock.md#setshouldfallback)
* [shouldFallback](_card_elements_.richtextblock.md#shouldfallback)
* [toJSON](_card_elements_.richtextblock.md#tojson)
* [truncateOverflow](_card_elements_.richtextblock.md#protected-truncateoverflow)
* [undoOverflowTruncation](_card_elements_.richtextblock.md#protected-undooverflowtruncation)
* [updateLayout](_card_elements_.richtextblock.md#updatelayout)
* [validateProperties](_card_elements_.richtextblock.md#validateproperties)
...
▸ **addInline**(`inline`: [CardElement](_card_elements_.cardelement.md)): *void*

**Parameters:**

Name | Type |
------ | ------ |
`inline` | [CardElement](_card_elements_.cardelement.md) |
...
▸ **getInlineAt**(`index`: number): *[CardElement](_card_elements_.cardelement.md)*
...
▸ **removeInline**(`inline`: [CardElement](_card_elements_.cardelement.md)): *boolean*
