[Adaptive Cards Javascript SDK](../README.md) › ["card-elements"](../modules/_card_elements_.md) › [Media](_card_elements_.media.md)
...
* [altText](_card_elements_.media.md#alttext)
* [customCssSelector](_card_elements_.media.md#customcssselector)
* [height](_card_elements_.media.md#height)
* [horizontalAlignment](_card_elements_.media.md#optional-horizontalalignment)
* [id](_card_elements_.media.md#id)
* [minPixelHeight](_card_elements_.media.md#optional-minpixelheight)
* [poster](_card_elements_.media.md#poster)
* [requires](_card_elements_.media.md#requires)
* [separator](_card_elements_.media.md#separator)
* [sources](_card_elements_.media.md#sources)
* [spacing](_card_elements_.media.md#spacing)
* [onPlay](_card_elements_.media.md#static-onplay)
* [supportedMediaTypes](_card_elements_.media.md#static-supportedmediatypes)

### Accessors

* [allowCustomPadding](_card_elements_.media.md#protected-allowcustompadding)
* [defaultStyle](_card_elements_.media.md#protected-defaultstyle)
* [hasVisibleSeparator](_card_elements_.media.md#hasvisibleseparator)
* [hostConfig](_card_elements_.media.md#hostconfig)
* [index](_card_elements_.media.md#index)
* [isInline](_card_elements_.media.md#isinline)
* [isInteractive](_card_elements_.media.md#isinteractive)
* [isStandalone](_card_elements_.media.md#isstandalone)
* [isVisible](_card_elements_.media.md#isvisible)
* [lang](_card_elements_.media.md#lang)
* [parent](_card_elements_.media.md#parent)
* [renderedElement](_card_elements_.media.md#renderedelement)
* [selectedMediaType](_card_elements_.media.md#selectedmediatype)
* [separatorElement](_card_elements_.media.md#separatorelement)
* [separatorOrientation](_card_elements_.media.md#protected-separatororientation)
* [supportsMinHeight](_card_elements_.media.md#protected-supportsminheight)
* [useDefaultSizing](_card_elements_.media.md#protected-usedefaultsizing)

### Methods

* [adjustRenderedElementSize](_card_elements_.media.md#protected-adjustrenderedelementsize)
* [applyPadding](_card_elements_.media.md#protected-applypadding)
* [asString](_card_elements_.media.md#asstring)
* [createPlaceholderElement](_card_elements_.media.md#protected-createplaceholderelement)
* [getActionAt](_card_elements_.media.md#getactionat)
* [getActionById](_card_elements_.media.md#getactionbyid)
* [getActionCount](_card_elements_.media.md#getactioncount)
* [getAllInputs](_card_elements_.media.md#getallinputs)
* [getCustomProperty](_card_elements_.media.md#getcustomproperty)
* [getDefaultPadding](_card_elements_.media.md#protected-getdefaultpadding)
* [getEffectivePadding](_card_elements_.media.md#geteffectivepadding)
* [getEffectiveStyle](_card_elements_.media.md#geteffectivestyle)
* [getElementById](_card_elements_.media.md#getelementbyid)
* [getForbiddenActionTypes](_card_elements_.media.md#getforbiddenactiontypes)
* [getForbiddenElementTypes](_card_elements_.media.md#getforbiddenelementtypes)
* [getHasBackground](_card_elements_.media.md#protected-gethasbackground)
* [getImmediateSurroundingPadding](_card_elements_.media.md#getimmediatesurroundingpadding)
* [getJsonTypeName](_card_elements_.media.md#getjsontypename)
* [getPadding](_card_elements_.media.md#protected-getpadding)
* [getParentContainer](_card_elements_.media.md#getparentcontainer)
* [getResourceInformation](_card_elements_.media.md#getresourceinformation)
* [getRootElement](_card_elements_.media.md#getrootelement)
* [indexOf](_card_elements_.media.md#indexof)
* [internalRender](_card_elements_.media.md#protected-internalrender)
* [internalValidateProperties](_card_elements_.media.md#internalvalidateproperties)
* [isAtTheVeryBottom](_card_elements_.media.md#isattheverybottom)
* [isAtTheVeryLeft](_card_elements_.media.md#isattheveryleft)
* [isAtTheVeryRight](_card_elements_.media.md#isattheveryright)
* [isAtTheVeryTop](_card_elements_.media.md#isattheverytop)
* [isBleeding](_card_elements_.media.md#isbleeding)
* [isBleedingAtBottom](_card_elements_.media.md#isbleedingatbottom)
* [isBleedingAtTop](_card_elements_.media.md#isbleedingattop)
* [isBottomElement](_card_elements_.media.md#isbottomelement)
* [isDesignMode](_card_elements_.media.md#isdesignmode)
* [isFirstElement](_card_elements_.media.md#isfirstelement)
* [isHiddenDueToOverflow](_card_elements_.media.md#ishiddenduetooverflow)
* [isLastElement](_card_elements_.media.md#islastelement)
* [isLeftMostElement](_card_elements_.media.md#isleftmostelement)
* [isRendered](_card_elements_.media.md#isrendered)
* [isRightMostElement](_card_elements_.media.md#isrightmostelement)
* [isTopElement](_card_elements_.media.md#istopelement)
* [overrideInternalRender](_card_elements_.media.md#protected-overrideinternalrender)
* [parse](_card_elements_.media.md#parse)
* [remove](_card_elements_.media.md#remove)
* [render](_card_elements_.media.md#render)
* [setCustomProperty](_card_elements_.media.md#setcustomproperty)
* [setPadding](_card_elements_.media.md#protected-setpadding)
* [setParent](_card_elements_.media.md#setparent)
* [setShouldFallback](_card_elements_.media.md#setshouldfallback)
* [shouldFallback](_card_elements_.media.md#shouldfallback)
* [toJSON](_card_elements_.media.md#tojson)
* [truncateOverflow](_card_elements_.media.md#protected-truncateoverflow)
* [undoOverflowTruncation](_card_elements_.media.md#protected-undooverflowtruncation)
* [updateLayout](_card_elements_.media.md#updatelayout)
* [validateProperties](_card_elements_.media.md#validateproperties)
...
• **sources**: *Array‹[MediaSource](_card_elements_.mediasource.md)›* = []
...
▸ (`sender`: [Media](_card_elements_.media.md)): *void*

**Parameters:**

Name | Type |
------ | ------ |
`sender` | [Media](_card_elements_.media.md) |
