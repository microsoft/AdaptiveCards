[Adaptive Cards Javascript SDK](../README.md) / [card-elements](../modules/card_elements.md) / TimeInput

# Class: TimeInput

[card-elements](../modules/card_elements.md).TimeInput
...
- [constructor](card_elements.timeinput.md#constructor)

### Properties

- [\_parent](card_elements.timeinput.md#_parent)
- [\_renderedElement](card_elements.timeinput.md#_renderedelement)
- [customCssSelector](card_elements.timeinput.md#customcssselector)
- [defaultValue](card_elements.timeinput.md#defaultvalue)
- [errorMessage](card_elements.timeinput.md#errormessage)
- [height](card_elements.timeinput.md#height)
- [horizontalAlignment](card_elements.timeinput.md#horizontalalignment)
- [id](card_elements.timeinput.md#id)
- [isRequired](card_elements.timeinput.md#isrequired)
- [label](card_elements.timeinput.md#label)
- [labelledBy](card_elements.timeinput.md#labelledby)
- [max](card_elements.timeinput.md#max)
- [maxVersion](card_elements.timeinput.md#maxversion)
- [min](card_elements.timeinput.md#min)
- [onPreProcessPropertyValue](card_elements.timeinput.md#onpreprocesspropertyvalue)
- [onValueChanged](card_elements.timeinput.md#onvaluechanged)
- [placeholder](card_elements.timeinput.md#placeholder)
- [separator](card_elements.timeinput.md#separator)
- [spacing](card_elements.timeinput.md#spacing)
- [defaultMaxVersion](card_elements.timeinput.md#defaultmaxversion)
- [errorMessageProperty](card_elements.timeinput.md#errormessageproperty)
- [heightProperty](card_elements.timeinput.md#heightproperty)
- [horizontalAlignmentProperty](card_elements.timeinput.md#horizontalalignmentproperty)
- [idProperty](card_elements.timeinput.md#idproperty)
- [isRequiredProperty](card_elements.timeinput.md#isrequiredproperty)
- [isVisibleProperty](card_elements.timeinput.md#isvisibleproperty)
- [labelProperty](card_elements.timeinput.md#labelproperty)
- [langProperty](card_elements.timeinput.md#langproperty)
- [maxProperty](card_elements.timeinput.md#maxproperty)
- [minProperty](card_elements.timeinput.md#minproperty)
- [onRegisterCustomProperties](card_elements.timeinput.md#onregistercustomproperties)
- [placeholderProperty](card_elements.timeinput.md#placeholderproperty)
- [requiresProperty](card_elements.timeinput.md#requiresproperty)
- [separatorProperty](card_elements.timeinput.md#separatorproperty)
- [spacingProperty](card_elements.timeinput.md#spacingproperty)
- [typeNameProperty](card_elements.timeinput.md#typenameproperty)
- [valueProperty](card_elements.timeinput.md#valueproperty)

### Accessors

- [allowCustomPadding](card_elements.timeinput.md#allowcustompadding)
- [defaultStyle](card_elements.timeinput.md#defaultstyle)
- [hasVisibleSeparator](card_elements.timeinput.md#hasvisibleseparator)
- [hostConfig](card_elements.timeinput.md#hostconfig)
- [index](card_elements.timeinput.md#index)
- [inputControlContainerElement](card_elements.timeinput.md#inputcontrolcontainerelement)
- [isInline](card_elements.timeinput.md#isinline)
- [isInteractive](card_elements.timeinput.md#isinteractive)
- [isNullable](card_elements.timeinput.md#isnullable)
- [isStandalone](card_elements.timeinput.md#isstandalone)
- [isVisible](card_elements.timeinput.md#isvisible)
- [lang](card_elements.timeinput.md#lang)
- [parent](card_elements.timeinput.md#parent)
- [renderedElement](card_elements.timeinput.md#renderedelement)
- [renderedInputControlElement](card_elements.timeinput.md#renderedinputcontrolelement)
- [requires](card_elements.timeinput.md#requires)
- [separatorElement](card_elements.timeinput.md#separatorelement)
- [separatorOrientation](card_elements.timeinput.md#separatororientation)
- [useDefaultSizing](card_elements.timeinput.md#usedefaultsizing)
- [value](card_elements.timeinput.md#value)

### Methods

- [adjustRenderedElementSize](card_elements.timeinput.md#adjustrenderedelementsize)
- [applyPadding](card_elements.timeinput.md#applypadding)
- [asString](card_elements.timeinput.md#asstring)
- [createPlaceholderElement](card_elements.timeinput.md#createplaceholderelement)
- [focus](card_elements.timeinput.md#focus)
- [getActionAt](card_elements.timeinput.md#getactionat)
- [getActionById](card_elements.timeinput.md#getactionbyid)
- [getActionCount](card_elements.timeinput.md#getactioncount)
- [getAllInputs](card_elements.timeinput.md#getallinputs)
- [getAllLabelIds](card_elements.timeinput.md#getalllabelids)
- [getCustomProperty](card_elements.timeinput.md#getcustomproperty)
- [getDefaultPadding](card_elements.timeinput.md#getdefaultpadding)
- [getDefaultSerializationContext](card_elements.timeinput.md#getdefaultserializationcontext)
- [getEffectivePadding](card_elements.timeinput.md#geteffectivepadding)
- [getEffectiveStyle](card_elements.timeinput.md#geteffectivestyle)
- [getEffectiveStyleDefinition](card_elements.timeinput.md#geteffectivestyledefinition)
- [getElementById](card_elements.timeinput.md#getelementbyid)
- [getForbiddenActionTypes](card_elements.timeinput.md#getforbiddenactiontypes)
- [getHasBackground](card_elements.timeinput.md#gethasbackground)
- [getImmediateSurroundingPadding](card_elements.timeinput.md#getimmediatesurroundingpadding)
- [getJsonTypeName](card_elements.timeinput.md#getjsontypename)
- [getPadding](card_elements.timeinput.md#getpadding)
- [getParentContainer](card_elements.timeinput.md#getparentcontainer)
- [getResourceInformation](card_elements.timeinput.md#getresourceinformation)
- [getRootElement](card_elements.timeinput.md#getrootelement)
- [getRootObject](card_elements.timeinput.md#getrootobject)
- [getSchema](card_elements.timeinput.md#getschema)
- [getSchemaKey](card_elements.timeinput.md#getschemakey)
- [getValue](card_elements.timeinput.md#getvalue)
- [hasAllDefaultValues](card_elements.timeinput.md#hasalldefaultvalues)
- [hasDefaultValue](card_elements.timeinput.md#hasdefaultvalue)
- [indexOf](card_elements.timeinput.md#indexof)
- [internalParse](card_elements.timeinput.md#internalparse)
- [internalRender](card_elements.timeinput.md#internalrender)
- [internalToJSON](card_elements.timeinput.md#internaltojson)
- [internalValidateProperties](card_elements.timeinput.md#internalvalidateproperties)
- [isAtTheVeryBottom](card_elements.timeinput.md#isattheverybottom)
- [isAtTheVeryLeft](card_elements.timeinput.md#isattheveryleft)
- [isAtTheVeryRight](card_elements.timeinput.md#isattheveryright)
- [isAtTheVeryTop](card_elements.timeinput.md#isattheverytop)
- [isBleeding](card_elements.timeinput.md#isbleeding)
- [isBleedingAtBottom](card_elements.timeinput.md#isbleedingatbottom)
- [isBleedingAtTop](card_elements.timeinput.md#isbleedingattop)
- [isBottomElement](card_elements.timeinput.md#isbottomelement)
- [isDesignMode](card_elements.timeinput.md#isdesignmode)
- [isDisplayed](card_elements.timeinput.md#isdisplayed)
- [isFirstElement](card_elements.timeinput.md#isfirstelement)
- [isHiddenDueToOverflow](card_elements.timeinput.md#ishiddenduetooverflow)
- [isLastElement](card_elements.timeinput.md#islastelement)
- [isLeftMostElement](card_elements.timeinput.md#isleftmostelement)
- [isRightMostElement](card_elements.timeinput.md#isrightmostelement)
- [isSet](card_elements.timeinput.md#isset)
- [isTopElement](card_elements.timeinput.md#istopelement)
- [isValid](card_elements.timeinput.md#isvalid)
- [overrideInternalRender](card_elements.timeinput.md#overrideinternalrender)
- [parse](card_elements.timeinput.md#parse)
- [populateSchema](card_elements.timeinput.md#populateschema)
- [preProcessPropertyValue](card_elements.timeinput.md#preprocesspropertyvalue)
- [remove](card_elements.timeinput.md#remove)
- [render](card_elements.timeinput.md#render)
- [resetDefaultValues](card_elements.timeinput.md#resetdefaultvalues)
- [resetValidationFailureCue](card_elements.timeinput.md#resetvalidationfailurecue)
- [setCustomProperty](card_elements.timeinput.md#setcustomproperty)
- [setPadding](card_elements.timeinput.md#setpadding)
- [setParent](card_elements.timeinput.md#setparent)
- [setShouldFallback](card_elements.timeinput.md#setshouldfallback)
- [setValue](card_elements.timeinput.md#setvalue)
- [shouldFallback](card_elements.timeinput.md#shouldfallback)
- [shouldSerialize](card_elements.timeinput.md#shouldserialize)
- [showValidationErrorMessage](card_elements.timeinput.md#showvalidationerrormessage)
- [toJSON](card_elements.timeinput.md#tojson)
- [truncateOverflow](card_elements.timeinput.md#truncateoverflow)
- [undoOverflowTruncation](card_elements.timeinput.md#undooverflowtruncation)
- [updateInputControlAriaLabelledBy](card_elements.timeinput.md#updateinputcontrolarialabelledby)
- [updateLayout](card_elements.timeinput.md#updatelayout)
- [validateProperties](card_elements.timeinput.md#validateproperties)
- [validateValue](card_elements.timeinput.md#validatevalue)
- [valueChanged](card_elements.timeinput.md#valuechanged)

## Constructors

### constructor

\+ **new TimeInput**(): [*TimeInput*](card_elements.timeinput.md)

**Returns:** [*TimeInput*](card_elements.timeinput.md)
...
Defined in: [card-elements.ts:3556](https://github.com/microsoft/AdaptiveCards/blob/0938a1f10/source/nodejs/adaptivecards/src/card-elements.ts#L3556)
...
Defined in: [card-elements.ts:3562](https://github.com/microsoft/AdaptiveCards/blob/0938a1f10/source/nodejs/adaptivecards/src/card-elements.ts#L3562)
...
Defined in: [card-elements.ts:3559](https://github.com/microsoft/AdaptiveCards/blob/0938a1f10/source/nodejs/adaptivecards/src/card-elements.ts#L3559)
...
Defined in: [card-elements.ts:3565](https://github.com/microsoft/AdaptiveCards/blob/0938a1f10/source/nodejs/adaptivecards/src/card-elements.ts#L3565)
...
▪ `Readonly` `Static` **maxProperty**: [*TimeProperty*](card_elements.timeproperty.md)

Defined in: [card-elements.ts:3553](https://github.com/microsoft/AdaptiveCards/blob/0938a1f10/source/nodejs/adaptivecards/src/card-elements.ts#L3553)

___

### minProperty

▪ `Readonly` `Static` **minProperty**: [*TimeProperty*](card_elements.timeproperty.md)

Defined in: [card-elements.ts:3552](https://github.com/microsoft/AdaptiveCards/blob/0938a1f10/source/nodejs/adaptivecards/src/card-elements.ts#L3552)
...
Defined in: [card-elements.ts:3551](https://github.com/microsoft/AdaptiveCards/blob/0938a1f10/source/nodejs/adaptivecards/src/card-elements.ts#L3551)
...
▪ `Readonly` `Static` **valueProperty**: [*TimeProperty*](card_elements.timeproperty.md)

Defined in: [card-elements.ts:3550](https://github.com/microsoft/AdaptiveCards/blob/0938a1f10/source/nodejs/adaptivecards/src/card-elements.ts#L3550)
...
Defined in: [card-elements.ts:3624](https://github.com/microsoft/AdaptiveCards/blob/0938a1f10/source/nodejs/adaptivecards/src/card-elements.ts#L3624)
...
Defined in: [card-elements.ts:3592](https://github.com/microsoft/AdaptiveCards/blob/0938a1f10/source/nodejs/adaptivecards/src/card-elements.ts#L3592)
...
Defined in: [card-elements.ts:3571](https://github.com/microsoft/AdaptiveCards/blob/0938a1f10/source/nodejs/adaptivecards/src/card-elements.ts#L3571)
...
Defined in: [card-elements.ts:3596](https://github.com/microsoft/AdaptiveCards/blob/0938a1f10/source/nodejs/adaptivecards/src/card-elements.ts#L3596)
...
Defined in: [card-elements.ts:3600](https://github.com/microsoft/AdaptiveCards/blob/0938a1f10/source/nodejs/adaptivecards/src/card-elements.ts#L3600)
