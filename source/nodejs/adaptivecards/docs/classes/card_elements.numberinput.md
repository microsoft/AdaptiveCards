[Adaptive Cards Javascript SDK](../README.md) / [card-elements](../modules/card_elements.md) / NumberInput

# Class: NumberInput

[card-elements](../modules/card_elements.md).NumberInput
...
- [constructor](card_elements.numberinput.md#constructor)

### Properties

- [\_parent](card_elements.numberinput.md#_parent)
- [\_renderedElement](card_elements.numberinput.md#_renderedelement)
- [customCssSelector](card_elements.numberinput.md#customcssselector)
- [defaultValue](card_elements.numberinput.md#defaultvalue)
- [errorMessage](card_elements.numberinput.md#errormessage)
- [height](card_elements.numberinput.md#height)
- [horizontalAlignment](card_elements.numberinput.md#horizontalalignment)
- [id](card_elements.numberinput.md#id)
- [isRequired](card_elements.numberinput.md#isrequired)
- [label](card_elements.numberinput.md#label)
- [labelledBy](card_elements.numberinput.md#labelledby)
- [max](card_elements.numberinput.md#max)
- [maxVersion](card_elements.numberinput.md#maxversion)
- [min](card_elements.numberinput.md#min)
- [onPreProcessPropertyValue](card_elements.numberinput.md#onpreprocesspropertyvalue)
- [onValueChanged](card_elements.numberinput.md#onvaluechanged)
- [placeholder](card_elements.numberinput.md#placeholder)
- [separator](card_elements.numberinput.md#separator)
- [spacing](card_elements.numberinput.md#spacing)
- [defaultMaxVersion](card_elements.numberinput.md#defaultmaxversion)
- [errorMessageProperty](card_elements.numberinput.md#errormessageproperty)
- [heightProperty](card_elements.numberinput.md#heightproperty)
- [horizontalAlignmentProperty](card_elements.numberinput.md#horizontalalignmentproperty)
- [idProperty](card_elements.numberinput.md#idproperty)
- [isRequiredProperty](card_elements.numberinput.md#isrequiredproperty)
- [isVisibleProperty](card_elements.numberinput.md#isvisibleproperty)
- [labelProperty](card_elements.numberinput.md#labelproperty)
- [langProperty](card_elements.numberinput.md#langproperty)
- [maxProperty](card_elements.numberinput.md#maxproperty)
- [minProperty](card_elements.numberinput.md#minproperty)
- [onRegisterCustomProperties](card_elements.numberinput.md#onregistercustomproperties)
- [placeholderProperty](card_elements.numberinput.md#placeholderproperty)
- [requiresProperty](card_elements.numberinput.md#requiresproperty)
- [separatorProperty](card_elements.numberinput.md#separatorproperty)
- [spacingProperty](card_elements.numberinput.md#spacingproperty)
- [typeNameProperty](card_elements.numberinput.md#typenameproperty)
- [valueProperty](card_elements.numberinput.md#valueproperty)

### Accessors

- [allowCustomPadding](card_elements.numberinput.md#allowcustompadding)
- [defaultStyle](card_elements.numberinput.md#defaultstyle)
- [hasVisibleSeparator](card_elements.numberinput.md#hasvisibleseparator)
- [hostConfig](card_elements.numberinput.md#hostconfig)
- [index](card_elements.numberinput.md#index)
- [inputControlContainerElement](card_elements.numberinput.md#inputcontrolcontainerelement)
- [isInline](card_elements.numberinput.md#isinline)
- [isInteractive](card_elements.numberinput.md#isinteractive)
- [isNullable](card_elements.numberinput.md#isnullable)
- [isStandalone](card_elements.numberinput.md#isstandalone)
- [isVisible](card_elements.numberinput.md#isvisible)
- [lang](card_elements.numberinput.md#lang)
- [parent](card_elements.numberinput.md#parent)
- [renderedElement](card_elements.numberinput.md#renderedelement)
- [renderedInputControlElement](card_elements.numberinput.md#renderedinputcontrolelement)
- [requires](card_elements.numberinput.md#requires)
- [separatorElement](card_elements.numberinput.md#separatorelement)
- [separatorOrientation](card_elements.numberinput.md#separatororientation)
- [useDefaultSizing](card_elements.numberinput.md#usedefaultsizing)
- [value](card_elements.numberinput.md#value)

### Methods

- [adjustRenderedElementSize](card_elements.numberinput.md#adjustrenderedelementsize)
- [applyPadding](card_elements.numberinput.md#applypadding)
- [asString](card_elements.numberinput.md#asstring)
- [createPlaceholderElement](card_elements.numberinput.md#createplaceholderelement)
- [focus](card_elements.numberinput.md#focus)
- [getActionAt](card_elements.numberinput.md#getactionat)
- [getActionById](card_elements.numberinput.md#getactionbyid)
- [getActionCount](card_elements.numberinput.md#getactioncount)
- [getAllInputs](card_elements.numberinput.md#getallinputs)
- [getAllLabelIds](card_elements.numberinput.md#getalllabelids)
- [getCustomProperty](card_elements.numberinput.md#getcustomproperty)
- [getDefaultPadding](card_elements.numberinput.md#getdefaultpadding)
- [getDefaultSerializationContext](card_elements.numberinput.md#getdefaultserializationcontext)
- [getEffectivePadding](card_elements.numberinput.md#geteffectivepadding)
- [getEffectiveStyle](card_elements.numberinput.md#geteffectivestyle)
- [getEffectiveStyleDefinition](card_elements.numberinput.md#geteffectivestyledefinition)
- [getElementById](card_elements.numberinput.md#getelementbyid)
- [getForbiddenActionTypes](card_elements.numberinput.md#getforbiddenactiontypes)
- [getHasBackground](card_elements.numberinput.md#gethasbackground)
- [getImmediateSurroundingPadding](card_elements.numberinput.md#getimmediatesurroundingpadding)
- [getJsonTypeName](card_elements.numberinput.md#getjsontypename)
- [getPadding](card_elements.numberinput.md#getpadding)
- [getParentContainer](card_elements.numberinput.md#getparentcontainer)
- [getResourceInformation](card_elements.numberinput.md#getresourceinformation)
- [getRootElement](card_elements.numberinput.md#getrootelement)
- [getRootObject](card_elements.numberinput.md#getrootobject)
- [getSchema](card_elements.numberinput.md#getschema)
- [getSchemaKey](card_elements.numberinput.md#getschemakey)
- [getValue](card_elements.numberinput.md#getvalue)
- [hasAllDefaultValues](card_elements.numberinput.md#hasalldefaultvalues)
- [hasDefaultValue](card_elements.numberinput.md#hasdefaultvalue)
- [indexOf](card_elements.numberinput.md#indexof)
- [internalParse](card_elements.numberinput.md#internalparse)
- [internalRender](card_elements.numberinput.md#internalrender)
- [internalToJSON](card_elements.numberinput.md#internaltojson)
- [internalValidateProperties](card_elements.numberinput.md#internalvalidateproperties)
- [isAtTheVeryBottom](card_elements.numberinput.md#isattheverybottom)
- [isAtTheVeryLeft](card_elements.numberinput.md#isattheveryleft)
- [isAtTheVeryRight](card_elements.numberinput.md#isattheveryright)
- [isAtTheVeryTop](card_elements.numberinput.md#isattheverytop)
- [isBleeding](card_elements.numberinput.md#isbleeding)
- [isBleedingAtBottom](card_elements.numberinput.md#isbleedingatbottom)
- [isBleedingAtTop](card_elements.numberinput.md#isbleedingattop)
- [isBottomElement](card_elements.numberinput.md#isbottomelement)
- [isDesignMode](card_elements.numberinput.md#isdesignmode)
- [isDisplayed](card_elements.numberinput.md#isdisplayed)
- [isFirstElement](card_elements.numberinput.md#isfirstelement)
- [isHiddenDueToOverflow](card_elements.numberinput.md#ishiddenduetooverflow)
- [isLastElement](card_elements.numberinput.md#islastelement)
- [isLeftMostElement](card_elements.numberinput.md#isleftmostelement)
- [isRightMostElement](card_elements.numberinput.md#isrightmostelement)
- [isSet](card_elements.numberinput.md#isset)
- [isTopElement](card_elements.numberinput.md#istopelement)
- [isValid](card_elements.numberinput.md#isvalid)
- [overrideInternalRender](card_elements.numberinput.md#overrideinternalrender)
- [parse](card_elements.numberinput.md#parse)
- [populateSchema](card_elements.numberinput.md#populateschema)
- [preProcessPropertyValue](card_elements.numberinput.md#preprocesspropertyvalue)
- [remove](card_elements.numberinput.md#remove)
- [render](card_elements.numberinput.md#render)
- [resetDefaultValues](card_elements.numberinput.md#resetdefaultvalues)
- [resetValidationFailureCue](card_elements.numberinput.md#resetvalidationfailurecue)
- [setCustomProperty](card_elements.numberinput.md#setcustomproperty)
- [setPadding](card_elements.numberinput.md#setpadding)
- [setParent](card_elements.numberinput.md#setparent)
- [setShouldFallback](card_elements.numberinput.md#setshouldfallback)
- [setValue](card_elements.numberinput.md#setvalue)
- [shouldFallback](card_elements.numberinput.md#shouldfallback)
- [shouldSerialize](card_elements.numberinput.md#shouldserialize)
- [showValidationErrorMessage](card_elements.numberinput.md#showvalidationerrormessage)
- [toJSON](card_elements.numberinput.md#tojson)
- [truncateOverflow](card_elements.numberinput.md#truncateoverflow)
- [undoOverflowTruncation](card_elements.numberinput.md#undooverflowtruncation)
- [updateInputControlAriaLabelledBy](card_elements.numberinput.md#updateinputcontrolarialabelledby)
- [updateLayout](card_elements.numberinput.md#updatelayout)
- [validateProperties](card_elements.numberinput.md#validateproperties)
- [validateValue](card_elements.numberinput.md#validatevalue)
- [valueChanged](card_elements.numberinput.md#valuechanged)

## Constructors

### constructor

\+ **new NumberInput**(): [*NumberInput*](card_elements.numberinput.md)

**Returns:** [*NumberInput*](card_elements.numberinput.md)
...
Defined in: [card-elements.ts:3357](https://github.com/microsoft/AdaptiveCards/blob/0938a1f10/source/nodejs/adaptivecards/src/card-elements.ts#L3357)
...
Defined in: [card-elements.ts:3363](https://github.com/microsoft/AdaptiveCards/blob/0938a1f10/source/nodejs/adaptivecards/src/card-elements.ts#L3363)
...
Defined in: [card-elements.ts:3360](https://github.com/microsoft/AdaptiveCards/blob/0938a1f10/source/nodejs/adaptivecards/src/card-elements.ts#L3360)
...
Defined in: [card-elements.ts:3366](https://github.com/microsoft/AdaptiveCards/blob/0938a1f10/source/nodejs/adaptivecards/src/card-elements.ts#L3366)
...
▪ `Readonly` `Static` **maxProperty**: [*NumProperty*](serialization.numproperty.md)

Defined in: [card-elements.ts:3354](https://github.com/microsoft/AdaptiveCards/blob/0938a1f10/source/nodejs/adaptivecards/src/card-elements.ts#L3354)

___

### minProperty

▪ `Readonly` `Static` **minProperty**: [*NumProperty*](serialization.numproperty.md)

Defined in: [card-elements.ts:3353](https://github.com/microsoft/AdaptiveCards/blob/0938a1f10/source/nodejs/adaptivecards/src/card-elements.ts#L3353)
...
Defined in: [card-elements.ts:3352](https://github.com/microsoft/AdaptiveCards/blob/0938a1f10/source/nodejs/adaptivecards/src/card-elements.ts#L3352)
...
▪ `Readonly` `Static` **valueProperty**: [*NumProperty*](serialization.numproperty.md)

Defined in: [card-elements.ts:3351](https://github.com/microsoft/AdaptiveCards/blob/0938a1f10/source/nodejs/adaptivecards/src/card-elements.ts#L3351)
...
Defined in: [card-elements.ts:3428](https://github.com/microsoft/AdaptiveCards/blob/0938a1f10/source/nodejs/adaptivecards/src/card-elements.ts#L3428)
...
Defined in: [card-elements.ts:3402](https://github.com/microsoft/AdaptiveCards/blob/0938a1f10/source/nodejs/adaptivecards/src/card-elements.ts#L3402)
...
Defined in: [card-elements.ts:3372](https://github.com/microsoft/AdaptiveCards/blob/0938a1f10/source/nodejs/adaptivecards/src/card-elements.ts#L3372)
...
Defined in: [card-elements.ts:3406](https://github.com/microsoft/AdaptiveCards/blob/0938a1f10/source/nodejs/adaptivecards/src/card-elements.ts#L3406)
...
Defined in: [card-elements.ts:3410](https://github.com/microsoft/AdaptiveCards/blob/0938a1f10/source/nodejs/adaptivecards/src/card-elements.ts#L3410)
