[Adaptive Cards Javascript SDK](../README.md) › ["card-elements"](../modules/_card_elements_.md) › [ActionSet](_card_elements_.actionset.md)
...
* [constructor](_card_elements_.actionset.md#constructor)

### Properties

* [customCssSelector](_card_elements_.actionset.md#customcssselector)
* [height](_card_elements_.actionset.md#height)
* [horizontalAlignment](_card_elements_.actionset.md#optional-horizontalalignment)
* [id](_card_elements_.actionset.md#id)
* [minPixelHeight](_card_elements_.actionset.md#optional-minpixelheight)
* [orientation](_card_elements_.actionset.md#optional-orientation)
* [requires](_card_elements_.actionset.md#requires)
* [separator](_card_elements_.actionset.md#separator)
* [spacing](_card_elements_.actionset.md#spacing)

### Accessors

* [allowCustomPadding](_card_elements_.actionset.md#protected-allowcustompadding)
* [defaultStyle](_card_elements_.actionset.md#protected-defaultstyle)
* [hasVisibleSeparator](_card_elements_.actionset.md#hasvisibleseparator)
* [hostConfig](_card_elements_.actionset.md#hostconfig)
* [index](_card_elements_.actionset.md#index)
* [isInline](_card_elements_.actionset.md#isinline)
* [isInteractive](_card_elements_.actionset.md#isinteractive)
* [isStandalone](_card_elements_.actionset.md#isstandalone)
* [isVisible](_card_elements_.actionset.md#isvisible)
* [lang](_card_elements_.actionset.md#lang)
* [parent](_card_elements_.actionset.md#parent)
* [renderedElement](_card_elements_.actionset.md#renderedelement)
* [separatorElement](_card_elements_.actionset.md#separatorelement)
* [separatorOrientation](_card_elements_.actionset.md#protected-separatororientation)
* [supportsMinHeight](_card_elements_.actionset.md#protected-supportsminheight)
* [useDefaultSizing](_card_elements_.actionset.md#protected-usedefaultsizing)

### Methods

* [addAction](_card_elements_.actionset.md#addaction)
* [adjustRenderedElementSize](_card_elements_.actionset.md#protected-adjustrenderedelementsize)
* [applyPadding](_card_elements_.actionset.md#protected-applypadding)
* [asString](_card_elements_.actionset.md#asstring)
* [createPlaceholderElement](_card_elements_.actionset.md#protected-createplaceholderelement)
* [getActionAt](_card_elements_.actionset.md#getactionat)
* [getActionById](_card_elements_.actionset.md#getactionbyid)
* [getActionCount](_card_elements_.actionset.md#getactioncount)
* [getAllInputs](_card_elements_.actionset.md#getallinputs)
* [getCustomProperty](_card_elements_.actionset.md#getcustomproperty)
* [getDefaultPadding](_card_elements_.actionset.md#protected-getdefaultpadding)
* [getEffectivePadding](_card_elements_.actionset.md#geteffectivepadding)
* [getEffectiveStyle](_card_elements_.actionset.md#geteffectivestyle)
* [getElementById](_card_elements_.actionset.md#getelementbyid)
* [getForbiddenActionTypes](_card_elements_.actionset.md#getforbiddenactiontypes)
* [getForbiddenElementTypes](_card_elements_.actionset.md#getforbiddenelementtypes)
* [getHasBackground](_card_elements_.actionset.md#protected-gethasbackground)
* [getImmediateSurroundingPadding](_card_elements_.actionset.md#getimmediatesurroundingpadding)
* [getJsonTypeName](_card_elements_.actionset.md#getjsontypename)
* [getPadding](_card_elements_.actionset.md#protected-getpadding)
* [getParentContainer](_card_elements_.actionset.md#getparentcontainer)
* [getResourceInformation](_card_elements_.actionset.md#getresourceinformation)
* [getRootElement](_card_elements_.actionset.md#getrootelement)
* [indexOf](_card_elements_.actionset.md#indexof)
* [internalRender](_card_elements_.actionset.md#protected-internalrender)
* [internalValidateProperties](_card_elements_.actionset.md#internalvalidateproperties)
* [isAtTheVeryBottom](_card_elements_.actionset.md#isattheverybottom)
* [isAtTheVeryLeft](_card_elements_.actionset.md#isattheveryleft)
* [isAtTheVeryRight](_card_elements_.actionset.md#isattheveryright)
* [isAtTheVeryTop](_card_elements_.actionset.md#isattheverytop)
* [isBleeding](_card_elements_.actionset.md#isbleeding)
* [isBleedingAtBottom](_card_elements_.actionset.md#isbleedingatbottom)
* [isBleedingAtTop](_card_elements_.actionset.md#isbleedingattop)
* [isBottomElement](_card_elements_.actionset.md#isbottomelement)
* [isDesignMode](_card_elements_.actionset.md#isdesignmode)
* [isFirstElement](_card_elements_.actionset.md#isfirstelement)
* [isHiddenDueToOverflow](_card_elements_.actionset.md#ishiddenduetooverflow)
* [isLastElement](_card_elements_.actionset.md#islastelement)
* [isLeftMostElement](_card_elements_.actionset.md#isleftmostelement)
* [isRendered](_card_elements_.actionset.md#isrendered)
* [isRightMostElement](_card_elements_.actionset.md#isrightmostelement)
* [isTopElement](_card_elements_.actionset.md#istopelement)
* [overrideInternalRender](_card_elements_.actionset.md#protected-overrideinternalrender)
* [parse](_card_elements_.actionset.md#parse)
* [remove](_card_elements_.actionset.md#remove)
* [render](_card_elements_.actionset.md#render)
* [setCustomProperty](_card_elements_.actionset.md#setcustomproperty)
* [setPadding](_card_elements_.actionset.md#protected-setpadding)
* [setParent](_card_elements_.actionset.md#setparent)
* [setShouldFallback](_card_elements_.actionset.md#setshouldfallback)
* [shouldFallback](_card_elements_.actionset.md#shouldfallback)
* [toJSON](_card_elements_.actionset.md#tojson)
* [truncateOverflow](_card_elements_.actionset.md#protected-truncateoverflow)
* [undoOverflowTruncation](_card_elements_.actionset.md#protected-undooverflowtruncation)
* [updateLayout](_card_elements_.actionset.md#updatelayout)
* [validateProperties](_card_elements_.actionset.md#validateproperties)

## Constructors

###  constructor

\+ **new ActionSet**(): *[ActionSet](_card_elements_.actionset.md)*

**Returns:** *[ActionSet](_card_elements_.actionset.md)*
...
• **orientation**? : *[Orientation](../enums/_enums_.orientation.md)* = null
