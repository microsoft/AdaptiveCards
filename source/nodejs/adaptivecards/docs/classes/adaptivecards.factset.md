[Adaptive Cards Javascript SDK](../README.md) / [adaptivecards](../modules/adaptivecards.md) / FactSet

# Class: FactSet

[adaptivecards](../modules/adaptivecards.md).FactSet
...
- [constructor](adaptivecards.factset.md#constructor)

### Properties

- [\_parent](adaptivecards.factset.md#_parent)
- [\_renderedElement](adaptivecards.factset.md#_renderedelement)
- [customCssSelector](adaptivecards.factset.md#customcssselector)
- [facts](adaptivecards.factset.md#facts)
- [height](adaptivecards.factset.md#height)
- [horizontalAlignment](adaptivecards.factset.md#horizontalalignment)
- [id](adaptivecards.factset.md#id)
- [maxVersion](adaptivecards.factset.md#maxversion)
- [onPreProcessPropertyValue](adaptivecards.factset.md#onpreprocesspropertyvalue)
- [separator](adaptivecards.factset.md#separator)
- [spacing](adaptivecards.factset.md#spacing)
- [defaultMaxVersion](adaptivecards.factset.md#defaultmaxversion)
- [factsProperty](adaptivecards.factset.md#factsproperty)
- [heightProperty](adaptivecards.factset.md#heightproperty)
- [horizontalAlignmentProperty](adaptivecards.factset.md#horizontalalignmentproperty)
- [idProperty](adaptivecards.factset.md#idproperty)
- [isVisibleProperty](adaptivecards.factset.md#isvisibleproperty)
- [langProperty](adaptivecards.factset.md#langproperty)
- [onRegisterCustomProperties](adaptivecards.factset.md#onregistercustomproperties)
- [requiresProperty](adaptivecards.factset.md#requiresproperty)
- [separatorProperty](adaptivecards.factset.md#separatorproperty)
- [spacingProperty](adaptivecards.factset.md#spacingproperty)
- [typeNameProperty](adaptivecards.factset.md#typenameproperty)

### Accessors

- [allowCustomPadding](adaptivecards.factset.md#allowcustompadding)
- [defaultStyle](adaptivecards.factset.md#defaultstyle)
- [hasVisibleSeparator](adaptivecards.factset.md#hasvisibleseparator)
- [hostConfig](adaptivecards.factset.md#hostconfig)
- [index](adaptivecards.factset.md#index)
- [isInline](adaptivecards.factset.md#isinline)
- [isInteractive](adaptivecards.factset.md#isinteractive)
- [isStandalone](adaptivecards.factset.md#isstandalone)
- [isVisible](adaptivecards.factset.md#isvisible)
- [lang](adaptivecards.factset.md#lang)
- [parent](adaptivecards.factset.md#parent)
- [renderedElement](adaptivecards.factset.md#renderedelement)
- [requires](adaptivecards.factset.md#requires)
- [separatorElement](adaptivecards.factset.md#separatorelement)
- [separatorOrientation](adaptivecards.factset.md#separatororientation)
- [useDefaultSizing](adaptivecards.factset.md#usedefaultsizing)

### Methods

- [adjustRenderedElementSize](adaptivecards.factset.md#adjustrenderedelementsize)
- [applyPadding](adaptivecards.factset.md#applypadding)
- [asString](adaptivecards.factset.md#asstring)
- [createPlaceholderElement](adaptivecards.factset.md#createplaceholderelement)
- [getActionAt](adaptivecards.factset.md#getactionat)
- [getActionById](adaptivecards.factset.md#getactionbyid)
- [getActionCount](adaptivecards.factset.md#getactioncount)
- [getAllInputs](adaptivecards.factset.md#getallinputs)
- [getCustomProperty](adaptivecards.factset.md#getcustomproperty)
- [getDefaultPadding](adaptivecards.factset.md#getdefaultpadding)
- [getDefaultSerializationContext](adaptivecards.factset.md#getdefaultserializationcontext)
- [getEffectivePadding](adaptivecards.factset.md#geteffectivepadding)
- [getEffectiveStyle](adaptivecards.factset.md#geteffectivestyle)
- [getEffectiveStyleDefinition](adaptivecards.factset.md#geteffectivestyledefinition)
- [getElementById](adaptivecards.factset.md#getelementbyid)
- [getForbiddenActionTypes](adaptivecards.factset.md#getforbiddenactiontypes)
- [getHasBackground](adaptivecards.factset.md#gethasbackground)
- [getImmediateSurroundingPadding](adaptivecards.factset.md#getimmediatesurroundingpadding)
- [getJsonTypeName](adaptivecards.factset.md#getjsontypename)
- [getPadding](adaptivecards.factset.md#getpadding)
- [getParentContainer](adaptivecards.factset.md#getparentcontainer)
- [getResourceInformation](adaptivecards.factset.md#getresourceinformation)
- [getRootElement](adaptivecards.factset.md#getrootelement)
- [getRootObject](adaptivecards.factset.md#getrootobject)
- [getSchema](adaptivecards.factset.md#getschema)
- [getSchemaKey](adaptivecards.factset.md#getschemakey)
- [getValue](adaptivecards.factset.md#getvalue)
- [hasAllDefaultValues](adaptivecards.factset.md#hasalldefaultvalues)
- [hasDefaultValue](adaptivecards.factset.md#hasdefaultvalue)
- [indexOf](adaptivecards.factset.md#indexof)
- [internalParse](adaptivecards.factset.md#internalparse)
- [internalRender](adaptivecards.factset.md#internalrender)
- [internalToJSON](adaptivecards.factset.md#internaltojson)
- [internalValidateProperties](adaptivecards.factset.md#internalvalidateproperties)
- [isAtTheVeryBottom](adaptivecards.factset.md#isattheverybottom)
- [isAtTheVeryLeft](adaptivecards.factset.md#isattheveryleft)
- [isAtTheVeryRight](adaptivecards.factset.md#isattheveryright)
- [isAtTheVeryTop](adaptivecards.factset.md#isattheverytop)
- [isBleeding](adaptivecards.factset.md#isbleeding)
- [isBleedingAtBottom](adaptivecards.factset.md#isbleedingatbottom)
- [isBleedingAtTop](adaptivecards.factset.md#isbleedingattop)
- [isBottomElement](adaptivecards.factset.md#isbottomelement)
- [isDesignMode](adaptivecards.factset.md#isdesignmode)
- [isDisplayed](adaptivecards.factset.md#isdisplayed)
- [isFirstElement](adaptivecards.factset.md#isfirstelement)
- [isHiddenDueToOverflow](adaptivecards.factset.md#ishiddenduetooverflow)
- [isLastElement](adaptivecards.factset.md#islastelement)
- [isLeftMostElement](adaptivecards.factset.md#isleftmostelement)
- [isRightMostElement](adaptivecards.factset.md#isrightmostelement)
- [isTopElement](adaptivecards.factset.md#istopelement)
- [overrideInternalRender](adaptivecards.factset.md#overrideinternalrender)
- [parse](adaptivecards.factset.md#parse)
- [populateSchema](adaptivecards.factset.md#populateschema)
- [preProcessPropertyValue](adaptivecards.factset.md#preprocesspropertyvalue)
- [remove](adaptivecards.factset.md#remove)
- [render](adaptivecards.factset.md#render)
- [resetDefaultValues](adaptivecards.factset.md#resetdefaultvalues)
- [setCustomProperty](adaptivecards.factset.md#setcustomproperty)
- [setPadding](adaptivecards.factset.md#setpadding)
- [setParent](adaptivecards.factset.md#setparent)
- [setShouldFallback](adaptivecards.factset.md#setshouldfallback)
- [setValue](adaptivecards.factset.md#setvalue)
- [shouldFallback](adaptivecards.factset.md#shouldfallback)
- [shouldSerialize](adaptivecards.factset.md#shouldserialize)
- [toJSON](adaptivecards.factset.md#tojson)
- [truncateOverflow](adaptivecards.factset.md#truncateoverflow)
- [undoOverflowTruncation](adaptivecards.factset.md#undooverflowtruncation)
- [updateLayout](adaptivecards.factset.md#updatelayout)
- [validateProperties](adaptivecards.factset.md#validateproperties)

## Constructors

### constructor

\+ **new FactSet**(): [*FactSet*](card_elements.factset.md)

**Returns:** [*FactSet*](card_elements.factset.md)
...
• **facts**: [*Fact*](card_elements.fact.md)[]
...
▪ `Readonly` `Static` **factsProperty**: [*SerializableObjectCollectionProperty*](serialization.serializableobjectcollectionproperty.md)
