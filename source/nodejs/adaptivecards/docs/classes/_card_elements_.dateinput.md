[Adaptive Cards Javascript SDK](../README.md) › ["card-elements"](../modules/_card_elements_.md) › [DateInput](_card_elements_.dateinput.md)
...
* [customCssSelector](_card_elements_.dateinput.md#customcssselector)
* [height](_card_elements_.dateinput.md#height)
* [horizontalAlignment](_card_elements_.dateinput.md#optional-horizontalalignment)
* [id](_card_elements_.dateinput.md#id)
* [minPixelHeight](_card_elements_.dateinput.md#optional-minpixelheight)
* [onValueChanged](_card_elements_.dateinput.md#onvaluechanged)
* [requires](_card_elements_.dateinput.md#requires)
* [separator](_card_elements_.dateinput.md#separator)
* [spacing](_card_elements_.dateinput.md#spacing)
* [title](_card_elements_.dateinput.md#title)
* [validation](_card_elements_.dateinput.md#validation)

### Accessors

* [allowCustomPadding](_card_elements_.dateinput.md#protected-allowcustompadding)
* [defaultStyle](_card_elements_.dateinput.md#protected-defaultstyle)
* [defaultValue](_card_elements_.dateinput.md#defaultvalue)
* [hasVisibleSeparator](_card_elements_.dateinput.md#hasvisibleseparator)
* [hostConfig](_card_elements_.dateinput.md#hostconfig)
* [index](_card_elements_.dateinput.md#index)
* [inputControlContainerElement](_card_elements_.dateinput.md#protected-inputcontrolcontainerelement)
* [isInline](_card_elements_.dateinput.md#isinline)
* [isInteractive](_card_elements_.dateinput.md#isinteractive)
* [isNullable](_card_elements_.dateinput.md#protected-isnullable)
* [isStandalone](_card_elements_.dateinput.md#isstandalone)
* [isVisible](_card_elements_.dateinput.md#isvisible)
* [lang](_card_elements_.dateinput.md#lang)
* [max](_card_elements_.dateinput.md#max)
* [min](_card_elements_.dateinput.md#min)
* [parent](_card_elements_.dateinput.md#parent)
* [renderedElement](_card_elements_.dateinput.md#renderedelement)
* [renderedInputControlElement](_card_elements_.dateinput.md#protected-renderedinputcontrolelement)
* [separatorElement](_card_elements_.dateinput.md#separatorelement)
* [separatorOrientation](_card_elements_.dateinput.md#protected-separatororientation)
* [supportsMinHeight](_card_elements_.dateinput.md#protected-supportsminheight)
* [useDefaultSizing](_card_elements_.dateinput.md#protected-usedefaultsizing)
* [value](_card_elements_.dateinput.md#value)

### Methods

* [adjustRenderedElementSize](_card_elements_.dateinput.md#protected-adjustrenderedelementsize)
* [applyPadding](_card_elements_.dateinput.md#protected-applypadding)
* [asString](_card_elements_.dateinput.md#asstring)
* [createPlaceholderElement](_card_elements_.dateinput.md#protected-createplaceholderelement)
* [getActionAt](_card_elements_.dateinput.md#getactionat)
* [getActionById](_card_elements_.dateinput.md#getactionbyid)
* [getActionCount](_card_elements_.dateinput.md#getactioncount)
* [getAllInputs](_card_elements_.dateinput.md#getallinputs)
* [getCustomProperty](_card_elements_.dateinput.md#getcustomproperty)
* [getDefaultPadding](_card_elements_.dateinput.md#protected-getdefaultpadding)
* [getEffectivePadding](_card_elements_.dateinput.md#geteffectivepadding)
* [getEffectiveStyle](_card_elements_.dateinput.md#geteffectivestyle)
* [getElementById](_card_elements_.dateinput.md#getelementbyid)
* [getForbiddenActionTypes](_card_elements_.dateinput.md#getforbiddenactiontypes)
* [getForbiddenElementTypes](_card_elements_.dateinput.md#getforbiddenelementtypes)
* [getHasBackground](_card_elements_.dateinput.md#protected-gethasbackground)
* [getImmediateSurroundingPadding](_card_elements_.dateinput.md#getimmediatesurroundingpadding)
* [getJsonTypeName](_card_elements_.dateinput.md#getjsontypename)
* [getPadding](_card_elements_.dateinput.md#protected-getpadding)
* [getParentContainer](_card_elements_.dateinput.md#getparentcontainer)
* [getResourceInformation](_card_elements_.dateinput.md#getresourceinformation)
* [getRootElement](_card_elements_.dateinput.md#getrootelement)
* [indexOf](_card_elements_.dateinput.md#indexof)
* [internalRender](_card_elements_.dateinput.md#protected-internalrender)
* [internalValidateProperties](_card_elements_.dateinput.md#internalvalidateproperties)
* [isAtTheVeryBottom](_card_elements_.dateinput.md#isattheverybottom)
* [isAtTheVeryLeft](_card_elements_.dateinput.md#isattheveryleft)
* [isAtTheVeryRight](_card_elements_.dateinput.md#isattheveryright)
* [isAtTheVeryTop](_card_elements_.dateinput.md#isattheverytop)
* [isBleeding](_card_elements_.dateinput.md#isbleeding)
* [isBleedingAtBottom](_card_elements_.dateinput.md#isbleedingatbottom)
* [isBleedingAtTop](_card_elements_.dateinput.md#isbleedingattop)
* [isBottomElement](_card_elements_.dateinput.md#isbottomelement)
* [isDesignMode](_card_elements_.dateinput.md#isdesignmode)
* [isFirstElement](_card_elements_.dateinput.md#isfirstelement)
* [isHiddenDueToOverflow](_card_elements_.dateinput.md#ishiddenduetooverflow)
* [isLastElement](_card_elements_.dateinput.md#islastelement)
* [isLeftMostElement](_card_elements_.dateinput.md#isleftmostelement)
* [isRendered](_card_elements_.dateinput.md#isrendered)
* [isRightMostElement](_card_elements_.dateinput.md#isrightmostelement)
* [isTopElement](_card_elements_.dateinput.md#istopelement)
* [overrideInternalRender](_card_elements_.dateinput.md#protected-overrideinternalrender)
* [parse](_card_elements_.dateinput.md#parse)
* [parseInputValue](_card_elements_.dateinput.md#protected-parseinputvalue)
* [remove](_card_elements_.dateinput.md#remove)
* [render](_card_elements_.dateinput.md#render)
* [resetValidationFailureCue](_card_elements_.dateinput.md#protected-resetvalidationfailurecue)
* [setCustomProperty](_card_elements_.dateinput.md#setcustomproperty)
* [setPadding](_card_elements_.dateinput.md#protected-setpadding)
* [setParent](_card_elements_.dateinput.md#setparent)
* [setShouldFallback](_card_elements_.dateinput.md#setshouldfallback)
* [shouldFallback](_card_elements_.dateinput.md#shouldfallback)
* [showValidationErrorMessage](_card_elements_.dateinput.md#protected-showvalidationerrormessage)
* [toJSON](_card_elements_.dateinput.md#tojson)
* [truncateOverflow](_card_elements_.dateinput.md#protected-truncateoverflow)
* [undoOverflowTruncation](_card_elements_.dateinput.md#protected-undooverflowtruncation)
* [updateLayout](_card_elements_.dateinput.md#updatelayout)
* [validateProperties](_card_elements_.dateinput.md#validateproperties)
* [validateValue](_card_elements_.dateinput.md#validatevalue)
* [valueChanged](_card_elements_.dateinput.md#protected-valuechanged)
