...
module.exports = (env, argv) => {
    ...
    return {
        mode: mode, target: 'web', entry: {
            ...
            devtool: devMode ? 'inline-source-map' : 'source-map', devServer: {
                static: {
                    directory: path.resolve(__dirname, './dist'),
                },
                liveReload: false,
            },
            resolve: {extensions: ['.ts', '.tsx', '.js']}, module: {
                rules:
                    [
                        {
                            test: /\.ts$/,
            ...
            plugins:
                [
                    new Dotenv(), new HtmlWebpackPlugin({
                    ...
                    new ConcatPlugin({
                        bundles: [{
                            ...
                            src: [
                                ...
                                './src/adaptivecards-ui-testapp.css'
                            ]
                        }],
                    }),
