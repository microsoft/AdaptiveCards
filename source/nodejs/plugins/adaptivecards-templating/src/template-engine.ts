...
import { IPlugin, PropertyBag } from "../../../adaptivecards/src/adaptivecards";


class TemplatePlugin implements IPlugin {
    name: string;
    ...
    hostConfig;
    contributes;
    beforeParse(source: any, context?: any) {
        var template = new Template(source)
        var card = template.expand({$root: context})
        return card;        
    }
    afterParse(source: PropertyBag, context?: any) {
