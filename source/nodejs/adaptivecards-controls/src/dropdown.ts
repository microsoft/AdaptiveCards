...
export class DropDownItem {
    ...
    render(): HTMLElement {
        if (!this._element) {
            ...
            this._element.setAttribute("ariaSelected", "false");
    ...
    set selectedIndex(index: number) {
        if (index >= 0 && index < this._renderedItems.length) {
            ...
            if (this._selectedIndex >= 0 && this._selectedIndex < this._renderedItems.length) {
                this._renderedItems[this._selectedIndex].setAttribute("ariaSelected", "false");
            }

            // select new item
            this._renderedItems[index].focus();
            this._renderedItems[index].setAttribute("ariaSelected", "true");
