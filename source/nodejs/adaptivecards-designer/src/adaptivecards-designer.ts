...
export const defaultMicrosoftHosts: containers.HostContainer[] = [
	...
	new containers.LightBerlinContainer("Berlin - Light (Test)", "containers/berlin-container-light.css"),
	new containers.DarkBerlinContainer("Berlin - Dark (Test)", "containers/berlin-container-dark.css")
]
