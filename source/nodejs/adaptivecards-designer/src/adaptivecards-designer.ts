...
export const defaultMicrosoftHosts: containers.HostContainer[] = [
	...
	new containers.VivaConnectionsContainerDark("Viva Connections - Dark", "containers/viva-connections-container-dark.css"),
	new containers.VivaConnectionsContainerLight("Viva Connections - Light", "containers/viva-connections-container-light.css"),
