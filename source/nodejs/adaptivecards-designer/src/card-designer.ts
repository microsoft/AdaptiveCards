...
export class CardDesigner extends Designer.DesignContext {
    ...
    private buildTreeView() {
        if (this._treeViewToolbox.content) {
            setInnerHtml(this._treeViewToolbox.content, "");

            if (this.designerSurface.isPreviewMode) {
                setInnerHtml(this.treeViewToolbox.content,
    ...
    private buildDataExplorer() {
        if (this._dataToolbox && this._dataToolbox.content) {
            setInnerHtml(this._dataToolbox.content, "");
    ...
    private buildPropertySheet(peer: DesignerPeers.DesignerPeer) {
        if (this._propertySheetToolbox.content) {
            ...
            setInnerHtml(this._propertySheetToolbox.content, "");
    ...
    private buildPalette() {
        ...
        setInnerHtml(this._toolPaletteToolbox.content, "");
    ...
    private recreateDesignerSurface() {
        ...
        setInnerHtml(this._designerHostElement, "");
                    ...
                    handlers: [
                        {
                            ...
                            cardData: {
                                thumbnail: () => {
                                    ...
                                    setInnerHtml(thumbnail, `<div class="acd-image-upload acd-open-sample-item">
