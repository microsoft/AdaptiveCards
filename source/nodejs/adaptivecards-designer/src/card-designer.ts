...
export class CardDesigner extends Designer.DesignContext {
    ...
    private buildTreeView() {
        if (this._treeViewToolbox.content) {
            Utils.clearElement(this._treeViewToolbox.content);

            if (this.designerSurface.isPreviewMode) {
                Utils.setInnerHtml(this.treeViewToolbox.content,
    ...
    private buildDataExplorer() {
        if (this._dataToolbox && this._dataToolbox.content) {
            Utils.clearElement(this._dataToolbox.content);
    ...
    private buildPropertySheet(peer: DesignerPeers.DesignerPeer) {
        if (this._propertySheetToolbox.content) {
            ...
            Utils.clearElement(this._propertySheetToolbox.content);
    ...
    private buildPalette() {
        ...
        Utils.clearElement(this._toolPaletteToolbox.content);
    ...
    private recreateDesignerSurface() {
        ...
        Utils.clearElement(this._designerHostElement);
                    ...
                    handlers: [
                        {
                            ...
                            cardData: {
                                thumbnail: () => {
                                    ...
                                    Utils.setInnerHtml(thumbnail, `<div class="acd-image-upload acd-open-sample-item">
