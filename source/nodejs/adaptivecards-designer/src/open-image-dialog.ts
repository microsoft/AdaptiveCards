...
export class FetchManager {
    ...
    async getPredictedData(imageContent) {
        ...
        const picResponse = await fetch(process.env.PIC_TO_CARD_PREDICTION_API+"/predict_json?format=template", option);
...
export class OpenImageDialog extends Dialog {
    ...
    private _predictedCardJSON: any = {
        template : {},
        data:{}
    };
