...
const std::string& BaseElement::GetId() const
{
    return m_id;
}

void BaseElement::SetId(std::string&& value)
{
    m_id = std::move(value);
}
...
const std::string& BaseElement::GetElementTypeString() const
{
    return m_typeString;
}

void BaseElement::SetElementTypeString(std::string&& value)
{
    m_typeString = std::move(value);
}
...
const Json::Value& BaseElement::GetAdditionalProperties() const
{
    return m_additionalProperties;
}

void BaseElement::SetAdditionalProperties(Json::Value&& value)
{
    m_additionalProperties = std::move(value);
}
void BaseElement::SetAdditionalProperties(const Json::Value& value)
{
                ...
                else
                {
                    ...
                    catch (const AdaptiveCardParseException&)
                    {
                        throw AdaptiveCardParseException(
                            ErrorStatusCode::InvalidPropertyValue, "Invalid version in requires value: '" + memberValue + "'");
                    }
                }
            }
            return;
