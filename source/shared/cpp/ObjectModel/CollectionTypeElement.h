...
namespace AdaptiveSharedNamespace
{
    ...
    public:
        ...
        // 1. ToLeadingEdge: bleed its leading edge to the leading edge of the target parent
        // 2. ToTrailingEdge: bleed its trailing edge to the trailing edge of the target parent
