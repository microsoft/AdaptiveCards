...
namespace AdaptiveSharedNamespace
{
    ...
    public:
        ...
        // when GetCanBleed() return
        // 1. BleedToLeading: must bleed its leading edge to the leading edge of the target parent
        // 2. BleedToTrailing: must bleed its trailing edge to the trailing edge of the target parent
        // 3. RestrictedInAllDrections: doesn't bleed
        // 3. BleedToBothEdges: restricted to both edges of the target parent
        ...
        ContainerBleedState GetCanBleed() const;
    ...
    private:
        void SetCanBleed(const ContainerBleedState value);
        ...
        ContainerBleedState m_canBleed;
        bool m_hasPadding;
        bool m_hasBleed;
