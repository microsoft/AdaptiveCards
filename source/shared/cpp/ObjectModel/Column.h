...
public:
    Column();
    Column(Spacing spacing, std::shared_ptr<Separator> separation,  std::string size);
    Column(Spacing spacing, std::shared_ptr<Separator> separation,  std::string size, std::vector<std::shared_ptr<BaseCardElement>>& items);
