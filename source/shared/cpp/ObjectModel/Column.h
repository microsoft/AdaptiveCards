...
public:
    Column();
    Column(Spacing spacing, std::shared_ptr<Separator> separation, std::string speak, std::string size, ContainerStyle style);
    Column(Spacing spacing, std::shared_ptr<Separator> separation, std::string speak, std::string size, ContainerStyle style, std::vector<std::shared_ptr<BaseCardElement>>& items);
