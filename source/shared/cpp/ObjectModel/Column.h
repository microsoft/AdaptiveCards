...
public:
    Column();
    Column(Spacing spacing, bool separator, std::string size);
    Column(Spacing spacing, bool separator, std::string size, std::vector<std::shared_ptr<BaseCardElement>>& items);
