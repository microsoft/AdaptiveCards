...
public:
    ChoiceSetInput();
    ChoiceSetInput(Spacing spacing, bool separation, std::string speak);
    ChoiceSetInput(Spacing spacing, bool separation, std::string speak, std::vector<std::shared_ptr<ChoiceInput>>& choices);
