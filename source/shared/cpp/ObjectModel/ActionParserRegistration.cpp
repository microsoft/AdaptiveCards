...
ActionElementParserWrapper::ActionElementParserWrapper(std::shared_ptr<ActionElementParser> parserToWrap) : m_parser{parserToWrap}
{
}
...
void ActionParserRegistration::RemoveParser(std::string const& elementType)
{
    ...
    {
        throw AdaptiveCardParseException(
            ErrorStatusCode::UnsupportedParserOverride, "Removing known action parsers is unsupported");
    }
}
