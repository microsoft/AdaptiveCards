...
class BaseCardElement;
    class ImageSet : public BaseCardElement
    {
        public:
        ImageSet();
        ImageSet(Spacing spacing, std::shared_ptr<Separator> separation, std::string speak);
        ImageSet(Spacing spacing, std::shared_ptr<Separator> separation, std::string speak, std::vector<std::shared_ptr<Image>>& images);
