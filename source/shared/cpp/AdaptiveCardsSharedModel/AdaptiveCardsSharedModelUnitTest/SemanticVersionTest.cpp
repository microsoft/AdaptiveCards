...
TEST_CLASS(SemanticVersionTests){public : TEST_METHOD(PositiveTest){{SemanticVersion version("1");
...
TEST_METHOD(NegativeTest)
{
    ...
    Assert::ExpectException<AdaptiveCardParseException>(
        [&]() { SemanticVersion version("1234567890123456789012345678901234567890"); });
