...
TEST_CLASS(MarkdownTests){TEST_METHOD(MarkDownBasicSanityTest_CanHandleEmptyStringTest){MarkDownParser parser("");
...
TEST_METHOD(Rule16Test_strongEmphasis)
{
    ...
    Assert::AreEqual<std::string>(
        "<p>hello <strong>how are</strong> <em>you <strong>i</strong> am <strong>great</strong> <em>thank</em> "
        "<strong>you</strong></em></p>",
        parser7.TransformToHtml());
...
TEST_METHOD(LinkBasicValidationTest_LinkWithComplexEmphasisString)
{
    ...
    Assert::AreEqual<std::string>(
        "<p><strong>Hello</strong> <em><a href=\"*www.naver.com*\"><em>hello</em></a></em></p>", parser.TransformToHtml());
}
...
TEST_METHOD(LinkBasicValidationTest_TwoLinksTest)
{
    ...
    Assert::AreEqual<std::string>(
        "<p><em>Hello</em> <em><a href=\"*www.naver.com*\"><em>hello</em></a></em>* Hello, <a "
        "href=\"www.microsoft.com\">second</a></p>",
...
TEST_METHOD(ListTest_MultipleListWithHyphenAndEmphasisTests)
{
    MarkDownParser parser("- hello world - hello hello\r- ***winner* winner** chicken dinner");
    Assert::AreEqual<std::string>(
        "<ul><li>hello world - hello hello</li><li><strong><em>winner</em> winner</strong> chicken dinner</li></ul>",
        parser.TransformToHtml());
    MarkDownParser parser2("* hello world * hello hello\r* ***winner* winner** chicken dinner");
    Assert::AreEqual<std::string>(
        "<ul><li>hello world * hello hello</li><li><strong><em>winner</em> winner</strong> chicken dinner</li></ul>",
...
TEST_METHOD(ListTest_MultipleListWithLinkTest)
{
    ...
    Assert::AreEqual<std::string>(
        "<ul><li>hello world</li><li>hello hello</li><li>new site = <a href=\"www.adaptivecards.io\">adaptive card</a></li></ul>",
        parser.TransformToHtml());
...
TEST_METHOD(OrderedListTest_MultipleListWithHyphenTests)
{
    ...
    Assert::AreEqual<std::string>(
        "<ol start=\"1\"><li>hello world - hello hello</li><li>winner winner chicken dinner</li></ol>", parser.TransformToHtml());
}
...
TEST_METHOD(OrderedListTest_MultipleListWithHyphenAndEmphasisTests)
{
    ...
    Assert::AreEqual<std::string>(
        "<ol start=\"1\"><li>hello world - hello hello</li></ol><ul><li><strong><em>winner</em> winner</strong> chicken "
        "dinner</li></ul>",
        parser.TransformToHtml());
}
...
TEST_METHOD(OrderedListTest_MultipleListWithLinkTest)
{
    ...
    Assert::AreEqual<std::string>(
        "<ol start=\"1\"><li>hello world</li><li>hello hello</li><li>new site = <a href=\"www.adaptivecards.io\">adaptive "
        "card</a></li></ol>",
        parser.TransformToHtml());
}
...
{
    MarkDownParser parser(
        "It's OK!\rClick [以前の製品のリンクで検索](https://www.microsoft.com)\rClick "
        "[以前の製品のリンクで検索](https://www.microsoft.com)");
    Assert::AreEqual<std::string>(
        "<p>It's OK!\rClick <a href=\"https://www.microsoft.com\">以前の製品のリンクで検索</a>\rClick <a "
        "href=\"https://www.microsoft.com\">以前の製品のリンクで検索</a></p>",
        parser.TransformToHtml());
}
...
{
    MarkDownParser parser(
        "1. Click [以前の製品のリンクで検索](https://www.microsoft.com)\r2. Click "
        "[以前の製品のリンクで検索](https://www.microsoft.com)");
    Assert::AreEqual<std::string>(
        "<ol start=\"1\"><li>Click <a href=\"https://www.microsoft.com\">以前の製品のリンクで検索</a></li><li>Click <a "
        "href=\"https://www.microsoft.com\">以前の製品のリンクで検索</a></li></ol>",
        parser.TransformToHtml());
}
...
{
    MarkDownParser parser(
        "It's not OK!\r1. Click [以前の製品のリンクで検索](https://www.microsoft.com)\r2. Click "
        "[以前の製品のリンクで検索](https://www.microsoft.com)");
    Assert::AreEqual<std::string>(
        "<p>It's not OK!</p><ol start=\"1\"><li>Click <a "
        "href=\"https://www.microsoft.com\">以前の製品のリンクで検索</a></li><li>Click <a "
        "href=\"https://www.microsoft.com\">以前の製品のリンクで検索</a></li></ol>",
        parser.TransformToHtml());
}
