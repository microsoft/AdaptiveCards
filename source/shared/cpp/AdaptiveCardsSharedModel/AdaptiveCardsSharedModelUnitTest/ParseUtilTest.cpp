...
TEST_CLASS(ParseUtilTest){public : static Json::Value s_GetJsonObject(const std::string& json){std::istringstream jsonStream(json);
...
TEST_METHOD(ExpectTypeStringTests)
{
    ...
    Assert::ExpectException<AdaptiveCardParseException>(
        [&]() { ParseUtil::ExpectTypeString(missingType, CardElementType::AdaptiveCard); });

    auto invalidType = s_GetJsonObjectWithType("InvalidType"s);
    Assert::ExpectException<AdaptiveCardParseException>(
        [&]() { ParseUtil::ExpectTypeString(invalidType, CardElementType::AdaptiveCard); });
...
TEST_METHOD(ExtractJsonValueTests)
{
    ...
    Assert::ExpectException<AdaptiveCardParseException>(
        [&]() { ParseUtil::ExtractJsonValue(jsonObj, AdaptiveCardSchemaKey::Accent, true); });
...
TEST_METHOD(GetBoolTests)
{
    auto jsonObj = s_GetValidJsonObject();
    Assert::ExpectException<AdaptiveCardParseException>(
        [&]() { ParseUtil::GetBool(jsonObj, AdaptiveCardSchemaKey::Accent, false, true); });
    ...
    auto jsonObjWithAccentArray = s_GetJsonObjectWithAccent("[\"thing1\", \"thing2\"]"s);
    Assert::ExpectException<AdaptiveCardParseException>(
        [&]() { ParseUtil::GetBool(jsonObjWithAccentArray, AdaptiveCardSchemaKey::Accent, false, true); });
}
...
TEST_METHOD(GetIntTests)
{
    auto jsonObj = s_GetValidJsonObject();
    Assert::ExpectException<AdaptiveCardParseException>(
        [&]() { ParseUtil::GetInt(jsonObj, AdaptiveCardSchemaKey::Accent, 0, true); });
    ...
    Assert::ExpectException<AdaptiveCardParseException>(
        [&]() { ParseUtil::GetInt(jsonObjWithInvalidType, AdaptiveCardSchemaKey::Accent, 0, true); });
...
TEST_METHOD(GetUIntTests)
{
    auto jsonObj = s_GetValidJsonObject();
    Assert::ExpectException<AdaptiveCardParseException>(
        [&]() { ParseUtil::GetUInt(jsonObj, AdaptiveCardSchemaKey::Accent, 0, true); });
    auto defaultValue = ParseUtil::GetUInt(jsonObj, AdaptiveCardSchemaKey::Accent, 0, false);
    Assert::AreEqual(defaultValue, 0U);

    auto jsonObjWithInvalidType = s_GetJsonObjectWithAccent("\"Invalid\""s);
    Assert::ExpectException<AdaptiveCardParseException>(
        [&]() { ParseUtil::GetUInt(jsonObjWithInvalidType, AdaptiveCardSchemaKey::Accent, 0, true); });

    auto jsonObjWithNegativeNumber = s_GetJsonObjectWithAccent("-1"s);
    Assert::ExpectException<AdaptiveCardParseException>(
        [&]() { ParseUtil::GetUInt(jsonObjWithNegativeNumber, AdaptiveCardSchemaKey::Accent, 0, true); });
...
TEST_METHOD(GetStringTests)
{
    auto jsonObj = s_GetValidJsonObject();
    Assert::ExpectException<AdaptiveCardParseException>(
        [&]() { ParseUtil::GetString(jsonObj, AdaptiveCardSchemaKey::Accent, true); });
    ...
    Assert::ExpectException<AdaptiveCardParseException>(
        [&]() { ParseUtil::GetString(jsonObjWithIntType, AdaptiveCardSchemaKey::Accent, true); });
...
TEST_METHOD(GetJsonStringTests)
{
    auto jsonObj = s_GetValidJsonObject();
    Assert::ExpectException<AdaptiveCardParseException>(
        [&]() { ParseUtil::GetJsonString(jsonObj, AdaptiveCardSchemaKey::Accent, true); });
