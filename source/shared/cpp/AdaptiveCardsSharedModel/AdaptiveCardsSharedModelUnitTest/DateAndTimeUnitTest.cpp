...
TEST_CLASS(TimeTest){public : TEST_METHOD(TransformToTimeTest){SKIP_TEST_OUTSIDE_PACIFIC_TIME();
TextBlock blck;
...
;
TEST_CLASS(DateTest){public : TEST_METHOD(TransformDateTest){SKIP_TEST_OUTSIDE_PACIFIC_TIME();
TextBlock blck;
...
;
TEST_CLASS(TimeAndDateInputTest){public : TEST_METHOD(TimeWithShortFormat){SKIP_TEST_OUTSIDE_PACIFIC_TIME();
TextBlock blck;
// New York
...
TEST_METHOD(TwoISO8601WithText)
{
    ...
    std::string testString =
        "You have arrived in New York on {{DATE(2017-10-27T22:27:00-04:00, SHORT)}} at {{TIME(2017-10-27T22:27:00-04:00)}}.\r "
        "have a good trip";
    blck.SetText(testString);
