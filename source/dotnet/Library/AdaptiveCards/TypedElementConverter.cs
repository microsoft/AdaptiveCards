...
namespace AdaptiveCards
{
    ...
    public class TypedElementConverter : JsonConverter
    {
        ...
        private static Lazy<Dictionary<string, Type>> g_typedElementTypes = new Lazy<Dictionary<string, Type>>(() =>
        {
            ...
            types[AdaptiveContainer.TYPE] = typeof(AdaptiveContainer);
            types[AdaptiveColumn.TYPE] = typeof(AdaptiveColumn);
            types[AdaptiveColumnSet.TYPE] = typeof(AdaptiveColumnSet);
            ...
            types[AdaptiveChoiceSetInput.TYPE] = typeof(AdaptiveChoiceSetInput);
