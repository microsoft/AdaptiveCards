...
radius:5
color:'#FFFFFF'
border.color:text1.activeFocus? 'black' : 'grey'
border.width:1
layer.enabled:text1.activeFocus ? true : false
layer.effect:Glow{
samples:25
color:'skyblue'
}
...
placeholderText:"Placeholder text 1"
}
Rectangle{
...
radius:5
color:'#FFFFFF'
border.color:text2.activeFocus? 'black' : 'grey'
border.width:1
layer.enabled:text2.activeFocus ? true : false
layer.effect:Glow{
samples:25
color:'skyblue'
}
...
placeholderText:"Placeholder text2"
}
Rectangle{
readonly property bool seperator:true
width:parent.width
...
radius:5
color:'#FFFFFF'
border.color:text3.activeFocus? 'black' : 'grey'
border.width:1
layer.enabled:text3.activeFocus ? true : false
layer.effect:Glow{
samples:25
color:'skyblue'
}
...
placeholderText:"Placeholder text3"
}
}
}
}
