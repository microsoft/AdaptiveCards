...
width:80
height:image_auto_1_img.implicitHeight / image_auto_1_img.implicitWidth * width
implicitWidth:width
color:bgColor
Image{
id:image_auto_1_img
...
readonly property string bgColor:'transparent'
width:80
height:image_auto_2_img.implicitHeight / image_auto_2_img.implicitWidth * width
implicitWidth:width
color:bgColor
Image{
id:image_auto_2_img
...
readonly property string bgColor:'transparent'
width:80
height:image_auto_3_img.implicitHeight / image_auto_3_img.implicitWidth * width
implicitWidth:width
color:bgColor
Image{
id:image_auto_3_img
...
readonly property string bgColor:'transparent'
width:80
height:image_auto_4_img.implicitHeight / image_auto_4_img.implicitWidth * width
implicitWidth:width
color:bgColor
Image{
id:image_auto_4_img
readonly property bool isImage:true
cache:false
source:"https://picsum.photos/200/200?image=400"
anchors.fill:parent
visible:parent.visible
}
}
...
readonly property string bgColor:'transparent'
width:80
height:image_auto_5_img.implicitHeight / image_auto_5_img.implicitWidth * width
implicitWidth:width
color:bgColor
Image{
id:image_auto_5_img
readonly property bool isImage:true
cache:false
source:"https://picsum.photos/300/200?image=500"
anchors.fill:parent
visible:parent.visible
}
}
...
readonly property string bgColor:'transparent'
width:80
height:image_auto_6_img.implicitHeight / image_auto_6_img.implicitWidth * width
implicitWidth:width
color:bgColor
Image{
id:image_auto_6_img
readonly property bool isImage:true
cache:false
source:"https://picsum.photos/200/200?image=600"
anchors.fill:parent
visible:parent.visible
}
}
...
readonly property string bgColor:'transparent'
width:80
height:image_auto_7_img.implicitHeight / image_auto_7_img.implicitWidth * width
implicitWidth:width
color:bgColor
Image{
id:image_auto_7_img
readonly property bool isImage:true
cache:false
source:"https://picsum.photos/300/200?image=700"
anchors.fill:parent
visible:parent.visible
}
}
...
readonly property string bgColor:'transparent'
width:80
height:image_auto_8_img.implicitHeight / image_auto_8_img.implicitWidth * width
implicitWidth:width
color:bgColor
Image{
id:image_auto_8_img
...
readonly property string bgColor:'transparent'
width:80
height:image_auto_9_img.implicitHeight / image_auto_9_img.implicitWidth * width
implicitWidth:width
color:bgColor
Image{
id:image_auto_9_img
readonly property bool isImage:true
cache:false
source:"https://picsum.photos/300/200?image=900"
anchors.fill:parent
visible:parent.visible
}
}
