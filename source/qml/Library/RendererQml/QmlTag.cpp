...
namespace RendererQml
{
    ...
    QmlTag& QmlTag::Property(const std::string& name, const std::string& value, bool isString)
    {
        ...
        {
            iterator->second = escapedValue;
            return *this;
        }
        m_properties.emplace_back(name, escapedValue);
        return *this;
    }
