...
void GetMediaPosterAsImage(_In_ ABI::AdaptiveCards::Rendering::WinAppSDK::IAdaptiveRenderContext* renderContext,
                           _In_ ABI::AdaptiveCards::Rendering::WinAppSDK::IAdaptiveRenderArgs* renderArgs,
                           _In_ ABI::AdaptiveCards::ObjectModel::WinAppSDK::IAdaptiveMedia* adaptiveMedia,
...
void GetMediaSource(_In_ ABI::AdaptiveCards::Rendering::WinAppSDK::IAdaptiveHostConfig* hostConfig,
                    _In_ ABI::AdaptiveCards::ObjectModel::WinAppSDK::IAdaptiveMedia* adaptiveMedia,
                    _Outptr_ ABI::Windows::Foundation::IUriRuntimeClass** mediaSourceUrl,
                    _Outptr_ HSTRING* mimeType);

HRESULT HandleMediaClick(_In_ ABI::AdaptiveCards::Rendering::WinAppSDK::IAdaptiveRenderContext* renderContext,
                         _In_ ABI::AdaptiveCards::ObjectModel::WinAppSDK::IAdaptiveMedia* adaptiveMedia,
                         ...
                         _In_ ABI::AdaptiveCards::Rendering::WinAppSDK::IAdaptiveMediaEventInvoker* mediaInvoker);
