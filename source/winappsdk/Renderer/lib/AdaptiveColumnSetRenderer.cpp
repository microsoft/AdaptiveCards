...
namespace winrt::AdaptiveCards::Rendering::WinUI3::implementation
{
                                                        ...
                                                        rtrender::AdaptiveRenderArgs const& renderArgs)
    {
        try
        {
            ...
            rtom::ContainerStyle containerStyle = ::AdaptiveCards::Rendering::WinUI3::XamlHelpers::HandleStylingAndPadding(
            ...
            /* ComPtr<IGrid> xamlGrid =
             ...
             RETURN_IF_FAILED(GetActivationFactory(HStringReference(RuntimeClass_Windows_UI_Xaml_Controls_Grid).Get(),
             &gridStatics));*/
