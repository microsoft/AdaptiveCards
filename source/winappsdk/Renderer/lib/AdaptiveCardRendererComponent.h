...
namespace AdaptiveCards::Rendering::WinAppSDK
{
    ...
    class AdaptiveCardRenderer
        : public Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<Microsoft::WRL::RuntimeClassType::WinRtClassicComMix>,
                                              Microsoft::WRL::Implements<ABI::AdaptiveCards::Rendering::WinAppSDK::IAdaptiveCardRenderer>,
    ...
    public:
        ...
        IFACEMETHODIMP put_HostConfig(_In_ ABI::AdaptiveCards::Rendering::WinAppSDK::IAdaptiveHostConfig* hostConfig) override;
        IFACEMETHODIMP get_HostConfig(_COM_Outptr_ ABI::AdaptiveCards::Rendering::WinAppSDK::IAdaptiveHostConfig** hostConfig) override;
        IFACEMETHODIMP put_FeatureRegistration(_In_ ABI::AdaptiveCards::Rendering::WinAppSDK::IAdaptiveFeatureRegistration* featureRegistration) override;
        IFACEMETHODIMP get_FeatureRegistration(_COM_Outptr_ ABI::AdaptiveCards::Rendering::WinAppSDK::IAdaptiveFeatureRegistration** featureRegistration) override;
        ...
        IFACEMETHODIMP RenderAdaptiveCard(_In_ ABI::AdaptiveCards::ObjectModel::WinAppSDK::IAdaptiveCard* adaptiveCard,
                                          _COM_Outptr_ ABI::AdaptiveCards::Rendering::WinAppSDK::IRenderedAdaptiveCard** result) override;
        ...
        IFACEMETHODIMP get_ElementRenderers(_COM_Outptr_ ABI::AdaptiveCards::Rendering::WinAppSDK::IAdaptiveElementRendererRegistration** result) override;
        IFACEMETHODIMP get_ActionRenderers(_COM_Outptr_ ABI::AdaptiveCards::Rendering::WinAppSDK::IAdaptiveActionRendererRegistration** result) override;

        ABI::AdaptiveCards::Rendering::WinAppSDK::IAdaptiveHostConfig* GetHostConfig();
        ...
        Microsoft::WRL::ComPtr<AdaptiveCards::Rendering::WinAppSDK::XamlBuilder> GetXamlBuilder();
        Microsoft::WRL::ComPtr<ABI::Windows::UI::Xaml::IResourceDictionary> GetActionSentimentResourceDictionary();

        IFACEMETHODIMP get_ResourceResolvers(_COM_Outptr_ ABI::AdaptiveCards::Rendering::WinAppSDK::IAdaptiveCardResourceResolvers** value);
