...
namespace AdaptiveCards::Rendering::Uwp
{
    ...
    private:
        HRESULT RenderCell(_In_ ABI::AdaptiveCards::ObjectModel::WinAppSDK::IAdaptiveTableCell* cell,
                           _In_ ABI::AdaptiveCards::Rendering::WinAppSDK::IAdaptiveRenderContext* renderContext,
                           _In_ ABI::AdaptiveCards::Rendering::WinAppSDK::IAdaptiveRenderArgs* renderArgs,
        ...
        HRESULT RenderRow(_In_ ABI::AdaptiveCards::ObjectModel::WinAppSDK::IAdaptiveTableRow* row,
                          _In_ ABI::Windows::Foundation::Collections::IVector<ABI::AdaptiveCards::ObjectModel::WinAppSDK::AdaptiveTableColumnDefinition*>* columns,
                          _In_ ABI::AdaptiveCards::Rendering::WinAppSDK::IAdaptiveRenderContext* renderContext,
                          _In_ ABI::AdaptiveCards::Rendering::WinAppSDK::IAdaptiveRenderArgs* renderArgs,
                          _In_ ABI::Windows::Foundation::IReference<ABI::AdaptiveCards::ObjectModel::WinAppSDK::VerticalContentAlignment>* verticalContentAlignment,
