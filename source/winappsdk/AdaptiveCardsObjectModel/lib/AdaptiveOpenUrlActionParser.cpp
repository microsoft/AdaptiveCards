...
namespace winrt::AdaptiveCards::ObjectModel::WinUI3::implementation
{
    ...
    {
        return ::AdaptiveCards::ObjectModel::WinUI3::FromJson<::AdaptiveCards::ObjectModel::WinUI3::AdaptiveOpenUrlAction, ::AdaptiveCards::OpenUrlAction, ::AdaptiveCards::OpenUrlActionParser>(
