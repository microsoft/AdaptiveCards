...
namespace AdaptiveCards::ObjectModel::WinAppSDK
{
    ...
    try
    {
        return AdaptiveCards::ObjectModel::WinAppSDK::FromJson<AdaptiveCards::ObjectModel::WinAppSDK::AdaptiveFactSet, AdaptiveCards::FactSet, AdaptiveCards::FactSetParser>(
