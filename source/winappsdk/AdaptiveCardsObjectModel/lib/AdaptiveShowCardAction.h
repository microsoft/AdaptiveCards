...
namespace AdaptiveCards::ObjectModel::WinUI3
{
    class DECLSPEC_UUID("429d6be9-a5f4-44dc-8dc3-3fe9b633ff1c") AdaptiveShowCardAction
        : public Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<Microsoft::WRL::RuntimeClassType::WinRtClassicComMix>,
                                              ABI::AdaptiveCards::ObjectModel::WinUI3::IAdaptiveShowCardAction,
    ...
    public:
        ...
        IFACEMETHODIMP get_Card(_COM_Outptr_ ABI::AdaptiveCards::ObjectModel::WinUI3::IAdaptiveCard** card) override;
        IFACEMETHODIMP put_Card(_In_ ABI::AdaptiveCards::ObjectModel::WinUI3::IAdaptiveCard* card) override;
