...
namespace AdaptiveCards::ObjectModel::WinUI3
{
    class DECLSPEC_UUID("d6031009-7039-4735-bd07-ab6d99b29f03") AdaptiveActionSet
        : public Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<Microsoft::WRL::RuntimeClassType::WinRtClassicComMix>,
                                              ABI::AdaptiveCards::ObjectModel::WinUI3::IAdaptiveActionSet,
    ...
    {
        InspectableClass(RuntimeClass_AdaptiveCards_ObjectModel_WinUI3_AdaptiveActionSet, BaseTrust);
    ...
    public:
        ...
        IFACEMETHODIMP get_Actions(
            _COM_Outptr_ ABI::Windows::Foundation::Collections::IVector<ABI::AdaptiveCards::ObjectModel::WinUI3::IAdaptiveActionElement*>** items) override;
        ...
        IFACEMETHODIMP put_Spacing(_In_ ABI::AdaptiveCards::ObjectModel::WinUI3::Spacing spacing) override
        {
        ...
        IFACEMETHODIMP put_Height(_In_ ABI::AdaptiveCards::ObjectModel::WinUI3::HeightType height) override
        {
    ...
    private:
        winrt::Windows::Foundation::Collections::IVector<winrt::AdaptiveCards::ObjectModel::WinUI3::IAdaptiveActionElement> m_actions;
    };
