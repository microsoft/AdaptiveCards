...
namespace AdaptiveCards::ObjectModel::WinAppSDK
{
    class DECLSPEC_UUID("ADF7ECAB-1405-4E42-83B0-ECEFFE7CE728") AdaptiveCard
        : public Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<Microsoft::WRL::RuntimeClassType::WinRt>,
                                              ABI::AdaptiveCards::ObjectModel::WinAppSDK::IAdaptiveCard,
    ...
    public:
        ...
        IFACEMETHODIMP get_VerticalContentAlignment(_Out_ ABI::AdaptiveCards::ObjectModel::WinAppSDK::VerticalContentAlignment* verticalAlignment) override;
        IFACEMETHODIMP put_VerticalContentAlignment(ABI::AdaptiveCards::ObjectModel::WinAppSDK::VerticalContentAlignment verticalAlignment) override;

        IFACEMETHODIMP get_Body(
            _COM_Outptr_ ABI::Windows::Foundation::Collections::IVector<ABI::AdaptiveCards::ObjectModel::WinAppSDK::IAdaptiveCardElement*>** body) override;

        IFACEMETHODIMP get_Actions(
            _COM_Outptr_ ABI::Windows::Foundation::Collections::IVector<ABI::AdaptiveCards::ObjectModel::WinAppSDK::IAdaptiveActionElement*>** actions) override;

        IFACEMETHODIMP get_ElementType(_Out_ ABI::AdaptiveCards::ObjectModel::WinAppSDK::ElementType* elementType) override;

        IFACEMETHODIMP get_Height(_Out_ ABI::AdaptiveCards::ObjectModel::WinAppSDK::HeightType* heightType) override;
        IFACEMETHODIMP put_Height(ABI::AdaptiveCards::ObjectModel::WinAppSDK::HeightType heightType) override;

        IFACEMETHODIMP get_MinHeight(_Out_ UINT32* minHeight) override;
        IFACEMETHODIMP put_MinHeight(UINT32 minHeight) override;

        IFACEMETHODIMP get_Refresh(_COM_Outptr_ ABI::AdaptiveCards::ObjectModel::WinAppSDK::IAdaptiveRefresh** refresh) override;
        IFACEMETHODIMP put_Refresh(_In_ ABI::AdaptiveCards::ObjectModel::WinAppSDK::IAdaptiveRefresh* refresh) override;

        IFACEMETHODIMP get_Authentication(_COM_Outptr_ ABI::AdaptiveCards::ObjectModel::WinAppSDK::IAdaptiveAuthentication** authentication) override;
        IFACEMETHODIMP put_Authentication(_In_ ABI::AdaptiveCards::ObjectModel::WinAppSDK::IAdaptiveAuthentication* authentication) override;
        ...
        IFACEMETHODIMP GetResourceInformation(_COM_Outptr_ ABI::Windows::Foundation::Collections::IVectorView<
                                              ABI::AdaptiveCards::ObjectModel::WinAppSDK::AdaptiveRemoteResourceInformation*>** uris) override;
    ...
    private:
        Microsoft::WRL::ComPtr<ABI::Windows::Foundation::Collections::IVector<ABI::AdaptiveCards::ObjectModel::WinAppSDK::IAdaptiveCardElement*>> m_body;
        ...
        ABI::AdaptiveCards::ObjectModel::WinAppSDK::HeightType m_height;
        ...
        ABI::AdaptiveCards::ObjectModel::WinAppSDK::VerticalContentAlignment m_verticalAlignment;
        Microsoft::WRL::ComPtr<ABI::AdaptiveCards::ObjectModel::WinAppSDK::IAdaptiveRefresh> m_refresh;
        Microsoft::WRL::ComPtr<ABI::AdaptiveCards::ObjectModel::WinAppSDK::IAdaptiveAuthentication> m_authentication;
    };

    class AdaptiveCardStaticsImpl WrlFinal
        : public Microsoft::WRL::AgileActivationFactory<ABI::AdaptiveCards::ObjectModel::WinAppSDK::IAdaptiveCardStatics>
    {
    ...
    public:
        ...
        IFACEMETHODIMP FromJson(_In_ ABI::Windows::Data::Json::IJsonObject* adaptiveJson,
                                _COM_Outptr_ ABI::AdaptiveCards::ObjectModel::WinAppSDK::IAdaptiveCardParseResult** parseResult) noexcept;
    ...
    private:
        HRESULT _FromJsonString(const std::string& jsonString,
                                _In_ ABI::AdaptiveCards::ObjectModel::WinAppSDK::IAdaptiveElementParserRegistration* elementParserRegistration,
                                _In_ ABI::AdaptiveCards::ObjectModel::WinAppSDK::IAdaptiveActionParserRegistration* actionParserRegistration,
                                _COM_Outptr_ ABI::AdaptiveCards::ObjectModel::WinAppSDK::IAdaptiveCardParseResult** parseResult);
    };
