...
namespace AdaptiveCards::ObjectModel::WinUI3
{
    ...
    public:
        ...
        IFACEMETHODIMP get_IsVisible(_Out_ ABI::AdaptiveCards::ObjectModel::WinUI3::IsVisible* value);
        IFACEMETHODIMP put_IsVisible(ABI::AdaptiveCards::ObjectModel::WinUI3::IsVisible value);
    ...
    private:
        ...
        ABI::AdaptiveCards::ObjectModel::WinUI3::IsVisible m_visibilityToggle;
    };
