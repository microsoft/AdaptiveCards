...
namespace AdaptiveCards::ObjectModel::WinUI3
{
    ...
    try
    {
        return AdaptiveCards::ObjectModel::WinUI3::FromJson<AdaptiveCards::ObjectModel::WinUI3::AdaptiveContainer, AdaptiveCards::Container, AdaptiveCards::ContainerParser>(
