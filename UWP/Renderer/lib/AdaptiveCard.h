...
namespace AdaptiveCards { namespace XamlCardRenderer
{
    ...
    public:
        ...
        // IAdaptiveCard
        IFACEMETHODIMP get_Version(_In_ HSTRING *version);
        IFACEMETHODIMP put_Version(_Out_ HSTRING version);

        IFACEMETHODIMP get_MinVersion(_In_ HSTRING *minVersion);
        IFACEMETHODIMP put_MinVersion(_Out_ HSTRING minVersion);

        IFACEMETHODIMP get_FallbackText(_In_ HSTRING *fallbackText);
        IFACEMETHODIMP put_FallbackText(_Out_ HSTRING fallbackText);
