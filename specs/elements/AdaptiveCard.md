...
Specifies whether input necessity indicators should be displayed on required inputs, optional inputs, or none at all.

* **Type**: `InputNecessityIndicators`
* **Version** : 1.3
* **Required**: No
* **Allowed values**:
  * `"none"`: Don't display any required/optional indicators on the inputs.
  * `"requiredInputs"`: Display required indicators on required inputs.
  * `"optionalInputs"`: Display optional indicators on optional inputs.
