...
| -------- | ---- | -------- | ----------- | ------- |
| **value** | `string` | Yes | The raw value for the choice. | 1.0 |
| **title** | `string` | No | Text to display. If style property of corresponding `Input.Feedback` is `rating`, then this text will be hidden from view. | 1.0 |
