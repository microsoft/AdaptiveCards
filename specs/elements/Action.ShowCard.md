...
| -------- | ---- | -------- | ----------- | ------- |
| **type** | `string` | Depends | Must be `"Action.ShowCard"`. | 1.0 |
...
| **iconUrl** | `uri-reference` | No | Optional icon to be shown on the action in conjunction with the title. Supports data URI in version 1.2+ | 1.0 |
...
| **style** | `ActionStyle` | No | Controls the style of an Action, which influences how the action is displayed, spoken, etc. | 1.0 |
| **fallback** | `Action|FallbackOption` | No | Describes what to do when an unknown element is encountered or the requires of this or any children can't be met. | 1.0 |
<!-- END AUTO-GENERATED -->
