...
See below section for proposed schema changes (https://github.com/baton17/AdaptiveCards/blob/inLineEditability/specs/DesignDiscussions/inlineEditability.md#proposed-schema-changes)
