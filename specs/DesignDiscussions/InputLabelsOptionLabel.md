...
Speaking of automation properties, they also include a property called "IsRequiredForForm", this property doesn't render but it helps the screen reader make it clear to fill information in the field.
