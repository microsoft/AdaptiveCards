...
namespace AdaptiveXamlRenderer
{
    public partial class AdaptiveRenderer
    {
        ...
        /// <returns></returns>
        public virtual UIElement Render(Container container, List<Control> inputControls)
        {
        ...
        /// <returns></returns>
        public virtual UIElement Render(ColumnGroup columnGroup, List<Control> inputControls)
        {
